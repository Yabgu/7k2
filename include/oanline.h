...
public:
  ...
  void draw_line(VgaBuf *, short x1, short y1, short x2, short y2,
                 int animatedFlag = 1, int effectFlag = 0);
  void thick_line(VgaBuf *, short x1, short y1, short x2, short y2,
                  int animatedFlag = 1, int effectFlag = 0);
  void inc_phase();

  void basic_line(VgaBuf *, short x1, short y1, short x2, short y2,
                  int animatedFlag, unsigned char *colorCode, int initPhase);
  void basic_hline(VgaBuf *, short x1, short x2, short y1, int animatedFlag,
                   unsigned char *colorCode, int initPhase);
  void basic_vline(VgaBuf *, short x1, short y1, short y2, int animatedFlag,
                   unsigned char *colorCode, int initPhase);
