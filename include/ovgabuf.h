...
public:
  ...
  void set_buf_ptr(short *bufPtr, long pitch) {
    surface->set_buf_ptr(bufPtr, pitch);
  }
  void set_default_buf_ptr() { surface->set_default_buf_ptr(); }

  int write_bmp_file(char *fileName) {
    return surface->write_bmp_file(fileName);
  }

  //---------- painting functions ----------//

  static int translate_color(
  ...
  void put_large_bitmap(int x1, int y1, File *filePtr,
                        short *colorRemapTable = 0);
  void put_large_bitmap_trans(int x1, int y1, File *filePtr,
                              short *colorRemapTable = 0);
  ...
  void put_bitmap_hmirror(int x, int y, char *bitmapBuf) {
    IMGbltRemapHMirror(cur_buf_ptr, cur_pitch, x, y, bitmapBuf,
                       default_remap_table);
  }

  void put_bitmap_area(int x, int y, char *bitmapBuf, int srcX1, int srcY1,
                       int srcX2, int srcY2) {
    IMGbltAreaRemap(cur_buf_ptr, cur_pitch, x, y, bitmapBuf, srcX1, srcY1,
                    srcX2, srcY2, default_remap_table);
  }

  void put_bitmap_area_hmirror(int x, int y, char *bitmapBuf, int srcX1,
                               int srcY1, int srcX2, int srcY2) {
    IMGbltAreaRemapHMirror(cur_buf_ptr, cur_pitch, x, y, bitmapBuf, srcX1,
                           srcY1, srcX2, srcY2, default_remap_table);
  }

  void put_bitmap_remap(int desX, int desY, char *bitmapBuf,
                        short *colorRemapTable);
  void put_bitmap_remap_fast(int x, int y, char *bitmapBuf,
                             short *colorRemapTable) {
    IMGbltRemap(cur_buf_ptr, cur_pitch, x, y, bitmapBuf, colorRemapTable);
  }

  void put_bitmap_remap_hmirror(int x, int y, char *bitmapBuf,
                                short *colorRemapTable) {
    IMGbltRemapHMirror(cur_buf_ptr, cur_pitch, x, y, bitmapBuf,
                       colorRemapTable);
  }

  void put_bitmap_area_remap(int x, int y, char *bitmapBuf, int srcX1,
                             int srcY1, int srcX2, int srcY2,
                             short *colorRemapTable) {
    IMGbltAreaRemap(cur_buf_ptr, cur_pitch, x, y, bitmapBuf, srcX1, srcY1,
  ...
  void put_bitmap_area_remap_hmirror(int x, int y, char *bitmapBuf, int srcX1,
                                     int srcY1, int srcX2, int srcY2,
                                     short *colorRemapTable) {
    IMGbltAreaRemapHMirror(cur_buf_ptr, cur_pitch, x, y, bitmapBuf, srcX1,
                           srcY1, srcX2, srcY2, colorRemapTable);
  }
  ...
  void put_bitmap_trans_fast(int x, int y, char *bitmapBuf) {
    IMGbltTransRemap(cur_buf_ptr, cur_pitch, x, y, bitmapBuf,
                     default_remap_table);
  }

  void put_bitmap_trans_hmirror(int x, int y, char *bitmapBuf) {
    IMGbltTransRemapHMirror(cur_buf_ptr, cur_pitch, x, y, bitmapBuf,
                            default_remap_table);
  }

  void put_bitmap_area_trans(int x, int y, char *bitmapBuf, int srcX1,
                             int srcY1, int srcX2, int srcY2) {
    IMGbltAreaTransRemap(cur_buf_ptr, cur_pitch, x, y, bitmapBuf, srcX1, srcY1,
                         srcX2, srcY2, default_remap_table);
  }

  void put_bitmap_area_trans_hmirror(int x, int y, char *bitmapBuf, int srcX1,
                                     int srcY1, int srcX2, int srcY2) {
    IMGbltAreaTransRemapHMirror(cur_buf_ptr, cur_pitch, x, y, bitmapBuf, srcX1,
                                srcY1, srcX2, srcY2, default_remap_table);
  }

  void put_bitmap_trans_remap(int x, int y, char *bitmapBuf,
                              short *colorRemapTable) {
    IMGbltTransRemap(cur_buf_ptr, cur_pitch, x, y, bitmapBuf, colorRemapTable);
  }

  void put_bitmap_trans_remap_hmirror(int x, int y, char *bitmapBuf,
                                      short *colorRemapTable) {
    IMGbltTransRemapHMirror(cur_buf_ptr, cur_pitch, x, y, bitmapBuf,
                            colorRemapTable);
  }

  void put_bitmap_area_trans_remap(int x, int y, char *bitmapBuf, int srcX1,
                                   int srcY1, int srcX2, int srcY2,
                                   short *colorRemapTable) {
    IMGbltAreaTransRemap(cur_buf_ptr, cur_pitch, x, y, bitmapBuf, srcX1, srcY1,
                         srcX2, srcY2, colorRemapTable);
  ...
  void put_bitmap_area_trans_remap_hmirror(int x, int y, char *bitmapBuf,
                                           int srcX1, int srcY1, int srcX2,
                                           int srcY2, short *colorRemapTable) {
    IMGbltAreaTransRemapHMirror(cur_buf_ptr, cur_pitch, x, y, bitmapBuf, srcX1,
                                srcY1, srcX2, srcY2, colorRemapTable);
  }
  ...
  void put_bitmap_trans_decompress(int x, int y, char *bitmapBuf) {
    IMGbltTransRemapDecompress(cur_buf_ptr, cur_pitch, x, y, bitmapBuf,
                               default_remap_table);
  }

  void put_bitmap_trans_decompress_hmirror(int x, int y, char *bitmapBuf) {
    IMGbltTransRemapDecompressHMirror(cur_buf_ptr, cur_pitch, x, y, bitmapBuf,
                                      default_remap_table);
  }

  void put_bitmap_area_trans_decompress(int x, int y, char *bitmapBuf,
                                        int srcX1, int srcY1, int srcX2,
                                        int srcY2) {
    IMGbltAreaTransRemapDecompress(cur_buf_ptr, cur_pitch, x, y, bitmapBuf,
                                   srcX1, srcY1, srcX2, srcY2,
                                   default_remap_table);
  }

  void put_bitmap_area_trans_decompress_hmirror(int x, int y, char *bitmapBuf,
                                                int srcX1, int srcY1, int srcX2,
                                                int srcY2) {
    IMGbltAreaTransRemapDecompressHMirror(cur_buf_ptr, cur_pitch, x, y,
                                          bitmapBuf, srcX1, srcY1, srcX2, srcY2,
                                          default_remap_table);
  }

  void put_bitmap_trans_remap_decompress(int x, int y, char *bitmapBuf,
                                         short *colorRemapTable) {
    IMGbltTransRemapDecompress(cur_buf_ptr, cur_pitch, x, y, bitmapBuf,
                               colorRemapTable);
  }

  void put_bitmap_trans_remap_decompress_hmirror(int x, int y, char *bitmapBuf,
                                                 short *colorRemapTable) {
    IMGbltTransRemapDecompressHMirror(cur_buf_ptr, cur_pitch, x, y, bitmapBuf,
                                      colorRemapTable);
  }

  void put_bitmap_area_trans_remap_decompress(int x, int y, char *bitmapBuf,
                                              int srcX1, int srcY1, int srcX2,
                                              int srcY2,
                                              short *colorRemapTable) {
    IMGbltAreaTransRemapDecompress(cur_buf_ptr, cur_pitch, x, y, bitmapBuf,
  ...
  void put_bitmap_area_trans_remap_decompress_hmirror(int x, int y,
                                                      char *bitmapBuf,
                                                      int srcX1, int srcY1,
                                                      int srcX2, int srcY2,
                                                      short *colorRemapTable) {
  ...
  void put_bitmap_half_decompress(int x, int y, char *bitmapBuf) {
    IMGbltHalfRemapDecompress(cur_buf_ptr, cur_pitch, x, y, bitmapBuf,
                              default_remap_table);
  }

  void put_bitmap_half_decompress_hmirror(int x, int y, char *bitmapBuf) {
    IMGbltHalfRemapDecompressHMirror(cur_buf_ptr, cur_pitch, x, y, bitmapBuf,
                                     default_remap_table);
  }

  void put_bitmap_area_half_decompress(int x, int y, char *bitmapBuf, int srcX1,
                                       int srcY1, int srcX2, int srcY2) {
    IMGbltAreaHalfRemapDecompress(cur_buf_ptr, cur_pitch, x, y, bitmapBuf,
                                  srcX1, srcY1, srcX2, srcY2,
                                  default_remap_table);
  }

  void put_bitmap_area_half_decompress_hmirror(int x, int y, char *bitmapBuf,
                                               int srcX1, int srcY1, int srcX2,
                                               int srcY2) {
    IMGbltAreaHalfRemapDecompressHMirror(cur_buf_ptr, cur_pitch, x, y,
                                         bitmapBuf, srcX1, srcY1, srcX2, srcY2,
                                         default_remap_table);
  }

  void put_bitmap_half_remap_decompress(int x, int y, char *bitmapBuf,
                                        short *colorRemapTable) {
    IMGbltHalfRemapDecompress(cur_buf_ptr, cur_pitch, x, y, bitmapBuf,
                              colorRemapTable);
  }

  void put_bitmap_half_remap_decompress_hmirror(int x, int y, char *bitmapBuf,
                                                short *colorRemapTable) {
    IMGbltHalfRemapDecompressHMirror(cur_buf_ptr, cur_pitch, x, y, bitmapBuf,
                                     colorRemapTable);
  }

  void put_bitmap_area_half_remap_decompress(int x, int y, char *bitmapBuf,
                                             int srcX1, int srcY1, int srcX2,
                                             int srcY2,
                                             short *colorRemapTable) {
    IMGbltAreaHalfRemapDecompress(cur_buf_ptr, cur_pitch, x, y, bitmapBuf,
  ...
  void put_bitmap_area_half_remap_decompress_hmirror(int x, int y,
                                                     char *bitmapBuf, int srcX1,
                                                     int srcY1, int srcX2,
                                                     int srcY2,
                                                     short *colorRemapTable) {
    IMGbltAreaHalfRemapDecompressHMirror(cur_buf_ptr, cur_pitch, x, y,
  ...
  void put_bitmap_blend(int x, int y, char *bitmapBuf) {
    IMGbltBlendRemap(cur_buf_ptr, cur_pitch, x, y, bitmapBuf,
                     default_blend_table);
  }

  void put_bitmap_blend_hmirror(int x, int y, char *bitmapBuf) {
    IMGbltBlendRemapHMirror(cur_buf_ptr, cur_pitch, x, y, bitmapBuf,
                            default_blend_table);
  }

  void put_bitmap_blend_area(int x, int y, char *bitmapBuf, int srcX1,
                             int srcY1, int srcX2, int srcY2) {
    IMGbltBlendAreaRemap(cur_buf_ptr, cur_pitch, x, y, bitmapBuf, srcX1, srcY1,
                         srcX2, srcY2, default_blend_table);
  }

  void put_bitmap_blend_area_hmirror(int x, int y, char *bitmapBuf, int srcX1,
                                     int srcY1, int srcX2, int srcY2) {
    IMGbltBlendAreaRemapHMirror(cur_buf_ptr, cur_pitch, x, y, bitmapBuf, srcX1,
                                srcY1, srcX2, srcY2, default_blend_table);
  }

  // functions with weak blend bitmap

  void put_bitmap_weak_blend(int x, int y, char *bitmapBuf) {
    IMGbltWeakblendRemap(cur_buf_ptr, cur_pitch, x, y, bitmapBuf,
                         default_blend_table);
  }

  void put_bitmap_weak_blend_hmirror(int x, int y, char *bitmapBuf) {
    IMGbltWeakblendRemapHMirror(cur_buf_ptr, cur_pitch, x, y, bitmapBuf,
                                default_blend_table);
  }

  void put_bitmap_weak_blend_area(int x, int y, char *bitmapBuf, int srcX1,
                                  int srcY1, int srcX2, int srcY2) {
    IMGbltWeakblendAreaRemap(cur_buf_ptr, cur_pitch, x, y, bitmapBuf, srcX1,
                             srcY1, srcX2, srcY2, default_blend_table);
  }

  void put_bitmap_weak_blend_area_hmirror(int x, int y, char *bitmapBuf,
                                          int srcX1, int srcY1, int srcX2,
                                          int srcY2) {
    IMGbltWeakblendAreaRemapHMirror(cur_buf_ptr, cur_pitch, x, y, bitmapBuf,
                                    srcX1, srcY1, srcX2, srcY2,
                                    default_blend_table);
  }
  ...
  void put_bitmapW_area(int x, int y, short *bitmapWBuf, int srcX1, int srcY1,
                        int srcX2, int srcY2) {
    IMGbltWArea(cur_buf_ptr, cur_pitch, x, y, bitmapWBuf, srcX1, srcY1, srcX2,
                srcY2);
  }
  void put_bitmapW_area(int x, int y, BitmapW *bitmapWBuf, int srcX1, int srcY1,
                        int srcX2, int srcY2) {
    IMGbltWArea(cur_buf_ptr, cur_pitch, x, y, (short *)bitmapWBuf, srcX1, srcY1,
                srcX2, srcY2);
  }
  ...
  void put_bitmapW_area_trans(int x, int y, short *bitmapWBuf, int srcX1,
                              int srcY1, int srcX2, int srcY2) {
    IMGbltWAreaTrans(cur_buf_ptr, cur_pitch, x, y, bitmapWBuf, srcX1, srcY1,
                     srcX2, srcY2);
  }
  void put_bitmapW_area_trans(int x, int y, BitmapW *bitmapWBuf, int srcX1,
                              int srcY1, int srcX2, int srcY2) {
    IMGbltWAreaTrans(cur_buf_ptr, cur_pitch, x, y, (short *)bitmapWBuf, srcX1,
                     srcY1, srcX2, srcY2);
  }
  ...
  void put_bitmapW_area_trans_blacken(int x, int y, short *bitmapWBuf,
                                      int srcX1, int srcY1, int srcX2,
                                      int srcY2) {
    IMGbltWAreaTransBlacken(cur_buf_ptr, cur_pitch, x, y, bitmapWBuf, srcX1,
                            srcY1, srcX2, srcY2);
  }
  void put_bitmapW_area_trans_blacken(int x, int y, BitmapW *bitmapWBuf,
                                      int srcX1, int srcY1, int srcX2,
                                      int srcY2) {
    IMGbltWAreaTransBlacken(cur_buf_ptr, cur_pitch, x, y, (short *)bitmapWBuf,
                            srcX1, srcY1, srcX2, srcY2);
  }
  ...
  void blt_buf_area(VgaBuf *srcBuf, int x1, int y1, int x2, int y2) {
    surface->blt_buf_area(srcBuf->surface, x1, y1, x2, y2);
  }

  void blt_virtual_buf(VgaBuf *srcBuf) {
    surface->blt_virtual_buf(srcBuf->surface);
  }

  void blt_virtual_buf_area(VgaBuf *srcBuf, int x1, int y1, int x2, int y2) {
    surface->blt_virtual_buf_area(srcBuf->surface, x1, y1, x2, y2);
  }

  void blt_buf_fast(VgaBuf *srcBuf, int srcX1, int srcY1, int srcX2,
                    int srcY2) {
    IMGcopyW(cur_buf_ptr, cur_pitch, srcBuf->cur_buf_ptr, srcBuf->cur_pitch,
             srcX1, srcY1, srcX2, srcY2);
  }
  // cut (srcX1,srcY1)-(srcX2,srcY2) of srcBuf and put at (srcX1,srcY1) of this
  // VgaBuf

  void blt_buf_bright(VgaBuf *srcBuf, int srcX1, int srcY1, int srcX2,
                      int srcY2, int brightness);

  void join_trans_remap(VgaBuf *srcBuf, int x, int y, char *bitmapBuf,
                        short *colorRemapTable) {
    IMGjoinTransRemap(cur_buf_ptr, cur_pitch, srcBuf->cur_buf_ptr,
                      srcBuf->cur_pitch, x, y, bitmapBuf, colorRemapTable);
  }

  void join_trans(VgaBuf *srcBuf, int x, int y, char *bitmapBuf) {
    IMGjoinTransRemap(cur_buf_ptr, cur_pitch, srcBuf->cur_buf_ptr,
                      srcBuf->cur_pitch, x, y, bitmapBuf, default_remap_table);
  }
