...
class VgaBuf
{
  ...
  public:
    ...
    short *buf_ptr()
    {
        return surface->buf_ptr();
    }
    short *buf_ptr(int x, int y)
    {
        return surface->buf_ptr(x, y);
    }

    // pitch in pixel
    int buf_pitch()
    {
        return surface->buf_pitch();
    } // in no. of pixel

    // pitch in byte
    int buf_true_pitch()
    {
        return surface->buf_true_pitch();
    }

    int buf_size()
    {
        return surface->buf_size();
    }
    int buf_width()
    {
        return surface->buf_width();
    }
    int buf_height()
    {
        return surface->buf_height();
    }
  ...
  public:
    ...
    BOOL is_buf_lost()
    {
        return surface->is_buf_lost();
    }
    BOOL restore_buf()
    {
        return surface->restore_buf();
    }
    bool is_inited()
    {
        return surface->is_inited();
    }
    ...
    {
        IMGbltAreaRemapHMirror(cur_buf_ptr, cur_pitch, x, y, bitmapBuf, srcX1, srcY1, srcX2, srcY2,
                               default_remap_table);
    }
    ...
    void put_bitmap_area_remap(int x, int y, char *bitmapBuf, int srcX1, int srcY1, int srcX2, int srcY2,
                               short *colorRemapTable)
    {
        IMGbltAreaRemap(cur_buf_ptr, cur_pitch, x, y, bitmapBuf, srcX1, srcY1, srcX2, srcY2, colorRemapTable);
    }

    void put_bitmap_area_remap_hmirror(int x, int y, char *bitmapBuf, int srcX1, int srcY1, int srcX2, int srcY2,
                                       short *colorRemapTable)
    {
    ...
    {
        IMGbltAreaTransRemapHMirror(cur_buf_ptr, cur_pitch, x, y, bitmapBuf, srcX1, srcY1, srcX2, srcY2,
                                    default_remap_table);
    }
    ...
    void put_bitmap_area_trans_remap(int x, int y, char *bitmapBuf, int srcX1, int srcY1, int srcX2, int srcY2,
                                     short *colorRemapTable)
    {
        IMGbltAreaTransRemap(cur_buf_ptr, cur_pitch, x, y, bitmapBuf, srcX1, srcY1, srcX2, srcY2, colorRemapTable);
    }

    void put_bitmap_area_trans_remap_hmirror(int x, int y, char *bitmapBuf, int srcX1, int srcY1, int srcX2, int srcY2,
                                             short *colorRemapTable)
    {
        IMGbltAreaTransRemapHMirror(cur_buf_ptr, cur_pitch, x, y, bitmapBuf, srcX1, srcY1, srcX2, srcY2,
                                    colorRemapTable);
    ...
    {
        IMGbltAreaTransRemapDecompress(cur_buf_ptr, cur_pitch, x, y, bitmapBuf, srcX1, srcY1, srcX2, srcY2,
                                       default_remap_table);
    }

    void put_bitmap_area_trans_decompress_hmirror(int x, int y, char *bitmapBuf, int srcX1, int srcY1, int srcX2,
                                                  int srcY2)
    {
        IMGbltAreaTransRemapDecompressHMirror(cur_buf_ptr, cur_pitch, x, y, bitmapBuf, srcX1, srcY1, srcX2, srcY2,
                                              default_remap_table);
    }
    ...
    void put_bitmap_area_trans_remap_decompress(int x, int y, char *bitmapBuf, int srcX1, int srcY1, int srcX2,
    ...
    void put_bitmap_area_trans_remap_decompress_hmirror(int x, int y, char *bitmapBuf, int srcX1, int srcY1, int srcX2,
                                                        int srcY2, short *colorRemapTable)
    {
        IMGbltAreaTransRemapDecompressHMirror(cur_buf_ptr, cur_pitch, x, y, bitmapBuf, srcX1, srcY1, srcX2, srcY2,
                                              colorRemapTable);
    ...
    {
        IMGbltAreaHalfRemapDecompress(cur_buf_ptr, cur_pitch, x, y, bitmapBuf, srcX1, srcY1, srcX2, srcY2,
                                      default_remap_table);
    }

    void put_bitmap_area_half_decompress_hmirror(int x, int y, char *bitmapBuf, int srcX1, int srcY1, int srcX2,
                                                 int srcY2)
    {
        IMGbltAreaHalfRemapDecompressHMirror(cur_buf_ptr, cur_pitch, x, y, bitmapBuf, srcX1, srcY1, srcX2, srcY2,
                                             default_remap_table);
    }
    ...
    void put_bitmap_area_half_remap_decompress(int x, int y, char *bitmapBuf, int srcX1, int srcY1, int srcX2,
                                               int srcY2, short *colorRemapTable)
    {
        IMGbltAreaHalfRemapDecompress(cur_buf_ptr, cur_pitch, x, y, bitmapBuf, srcX1, srcY1, srcX2, srcY2,
                                      colorRemapTable);
    ...
    void put_bitmap_area_half_remap_decompress_hmirror(int x, int y, char *bitmapBuf, int srcX1, int srcY1, int srcX2,
                                                       int srcY2, short *colorRemapTable)
    {
        IMGbltAreaHalfRemapDecompressHMirror(cur_buf_ptr, cur_pitch, x, y, bitmapBuf, srcX1, srcY1, srcX2, srcY2,
                                             colorRemapTable);
    ...
    {
        IMGbltBlendAreaRemapHMirror(cur_buf_ptr, cur_pitch, x, y, bitmapBuf, srcX1, srcY1, srcX2, srcY2,
                                    default_blend_table);
    }
    ...
    {
        IMGbltWeakblendAreaRemap(cur_buf_ptr, cur_pitch, x, y, bitmapBuf, srcX1, srcY1, srcX2, srcY2,
                                 default_blend_table);
    }

    void put_bitmap_weak_blend_area_hmirror(int x, int y, char *bitmapBuf, int srcX1, int srcY1, int srcX2, int srcY2)
    {
        IMGbltWeakblendAreaRemapHMirror(cur_buf_ptr, cur_pitch, x, y, bitmapBuf, srcX1, srcY1, srcX2, srcY2,
                                        default_blend_table);
    }
    ...
    {
        IMGjoinTransRemap(cur_buf_ptr, cur_pitch, srcBuf->cur_buf_ptr, srcBuf->cur_pitch, x, y, bitmapBuf,
                          colorRemapTable);
    }
    ...
    void flip(VgaBuf *srcBuf)
    {
        surface->flip(srcBuf->surface);
    }
};
