...
class World
{
  ...
  public:
    ...
    int locate_space(int &xLoc1, int &yLoc1, int xLoc2, int yLoc2, int spaceLocWidth, int spaceLocHeight,
                     int mobileType = UNIT_LAND, int regionId = 0, int buildFlag = 0);
    int check_unit_space(int xLoc1, int yLoc1, int xLoc2, int yLoc2, int mobileType = UNIT_LAND, int buildFlag = 0);

    int locate_space_random(int &xLoc1, int &yLoc1, int xLoc2, int yLoc2, int spaceLocWidth, int spaceLocHeight,
                            int maxTries, int regionId = 0, int buildSite = 0, char teraMask = 1);

    int net_attacker_power_in_area(int targetXLoc, int targetYLoc, int attackerWorldRecno, int defenderWorldRecno,
                                   int returnIfWar, int &hasWar, int scanRange);

    int is_adjacent_region(int x, int y, int regionId);

    void draw_link_line(int srcFirmId, int srcTownRecno, int srcXLoc1, int srcYLoc1, int srcXLoc2, int srcYLoc2,
    ...
    void build_wall_section(short x1, short y1, short x2, short y2, short townRecno, short initHp = 99);
