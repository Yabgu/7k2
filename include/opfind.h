...
class PathFinder
{
  ...
  public:
    ...
    bool find_path(int sourceX, int sourceY, int destX, int destY, int destRangeX1, int destRangeY1, int destRangeX2,
                   int destRangeY2, bool raiseIt = 1, bool raiseDest = 1, int maxTries = 0, int stopAtRange = 0);
