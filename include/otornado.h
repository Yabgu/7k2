...
class Tornado : public Sprite
{
  public:
    ...
    short dmg_offset_x;
    short dmg_offset_y;
    short damage_player_flag; // local player variable
  ...
  public:
    ...
    short damage_x_loc()
    {
        return (cur_x + dmg_offset_x) >> ZOOM_X_SHIFT_COUNT;
    }
    short damage_y_loc()
    {
        return (cur_y + dmg_offset_y) >> ZOOM_Y_SHIFT_COUNT;
    }
...
class TornadoArray : public SpriteArray
{
  public:
    ...
    short add_tornado(int xLoc, int yLoc,
                      short lifeTime); // unit attacks firm, townzone
                                       // short tornado_possible(int parentXLoc, int parentYLoc,
                                       // int targetXLoc, int targetYLoc, char tornadoSpeed);
