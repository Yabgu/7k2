...
class Nation : public NationBase
{
  ...
  public:
    ...
    int revealed_by_phoenix(int xLoc,
    ...
    short *update_ai_array(short &aiInfoCount, short &aiInfoSize, short **aiInfoArray, int arrayIncSize, int actionType,
                           int actionRecno);
    ...
    void del_firm_info(char firmId,
    ...
    void assign_firm_overseer(char firm_id, short firm_recno,
    ...
    int find_best_place_loc(short firmId, short refXLoc, short refYLoc, short &resultXLoc, short &resultYLoc,
                            short distance = 0);

    //------------------------------------------------------------//
    // functions for dealing with the AI action array
    //------------------------------------------------------------//
    int add_action(short xLoc, short yLoc, short refXLoc, short refYLoc, int actionType, int actionPara,
                   int instanceCount = 1, int unitRecno = 0, int actionPara2 = 0, short *groupUnitArray = NULL);
    int add_action(ActionNode *actionNode, int immediateProcess = 0);
    void del_action(int actionRecno);
    int is_action_exist(short actionXLoc, short actionYLoc, short refXLoc, short refYLoc, int actionType,
                        int actionPara, int unitRecno = 0);
    ...
    int check_firm_ready(short xLoc, short yLoc,
                         int firmId = 0); // check whether firm exists and belongs to our nation
    int check_town_ready(short xLoc,
    ...
    int ai_attack_target(int targetXLoc, int targetYLoc, int targetCombatLevel, int defenseMode = 0,
                         int justMoveToFlag = 0, int attackerMinCombatLevel = 0, int attackerCampRecno = 0,
                         int useAllCamp = 0, int retainCombatLevel = 0);
    ...
    int mobile_defense_combat_level(int targetXLoc, int targetYLoc, int targetNationRecno, int returnIfWar,
                                    int &hasWar);
