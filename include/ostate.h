...
public:
  ...
  unsigned short flags; // bit0=west bound, bit1=north bound, bit2=east bound,
                        // bit3=south bound,
...
public:
  ...
  //	int		is_adjacent_to_nation(int campaignNationRecno); // use
  //StateArray::is_adjacent_to_nation
  int is_near_border();
...
public:
  ...
  int nation_state_count(
      int campaignNationRecno); // number of states owned by this nation
