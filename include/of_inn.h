...
#define MAX_INN_UNIT_PER_REGION                                                \
  24 // maximum no. of inn units in any single region
...
public:
  ...
  short spy_skill; // >0 if this unit is a spy with a spying skill for hire, he
                   // is added by FirmInn
