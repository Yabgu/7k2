...
public:
  ...
  short first_first_name_id; // first <first name> of this race in
                             // first_name_array[]
  short
      first_last_name_id; // first <last name> of this race in last_name_array[]
  ...
  short civilian_unit_id;
  short infantry_unit_id;
