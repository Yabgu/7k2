...
public:
  ...
  short ai_capture_town_recno; // >0 if the troop is in the process of attacking
                               // the independent village for capturing it.
  ...
  static short action_spy_recno; // recno of the spy that is doing the bribing
                                 // or viewing secret reports of other nations
  static char bribe_result;
  static char assassinate_result;
  static short steal_tech_result;
  static char create_incident_result;
  static short
      action_target_recno; // recno of bribe/assassinate/incident target
...
public:
  ...
  int spy_bribe_succeed_chance(int bribeAmount, short briberSpyRecno,
                               short soldierId);
...
protected:
  ...
  void think_linked_town_change_nation(int linkedTownRecno, int oldNationRecno,
                                       int newNationRecno);
