...
inline void FileTimeToLocalFileTime(const FILETIME *lpFileTime,
...
inline void FileTimeToSystemTime(const FILETIME *lpFileTime,
                                 SYSTEMTIME *lpSystemTime) {
  uint64_t t = (static_cast<uint64_t>(lpFileTime->dwHighDateTime) << 32) |
