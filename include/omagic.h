...
class Magic
{
  ...
  public:
    ...
    ~Magic();
    void test_flag();
    void draw_light_angle(VgaBuf *vgabuf, int x1, int y1, int radius, int thickness, int lightness, short R1, short G1,
                          short B1, short R2, short G2, short B2, int mode);
    void generate_particle(int x1, int y1, int x2, int y2, int dirx, int diry, int type, int var, int mode, int number,
                           int birth_time, int lifecount, int lifeLimit, int lifeOffset = 0);
    void draw_particle(int x1, int y1, int x2, int y2, int dirx, int diry, int type, int var, int size, VgaBuf *vgabuf,
                       int mode, int number, int birth_time, int lifecount, int life_limit, int lifeOffset = 0);
    ...
    void straight_light_beam(VgaBuf *vgabuf, int x1, int y1, int x2, int y2, int thickness, int lightness, short R1,
                             short G1, short B1, short R2, short G2, short B2, int mode, char angle);
    void straight_light_beam2(VgaBuf *vgabuf, int x1, int y1, int x2, int y2, int thickness, int lightness, short R1,
                              short G1, short B1, short R2, short G2, short B2, int mode, char angle);
    void draw_light_beam(VgaBuf *vgabuf, int x1, int y1, int x2, int y2, int thickness, int lightness, short R1,
                         short G1, short B1, short R2, short G2, short B2, int mode, char angle, char fast = 1);
    void draw_light_ball(VgaBuf *vgabuf, int x1, int y1, int radius, int thickness, int lightness, short R1, short G1,
                         short B1, short R2, short G2, short B2, int mode);
    void zigzag_light_beam(VgaBuf *vgabuf, double x1, double y1, double x2, double y2, int thickness, int lightness,
                           short R1, short G1, short B1, short R2, short G2, short B2, int mode, unsigned rough,
                           int span);
    void draw_circle(VgaBuf *vgabuf, int x1, int y1, int radius, char r_x, char r_y, short R1, short G1, short B1,
                     int mode, int dir);

    void draw_circle2(VgaBuf *vgabuf, int x1, int y1, int radius, char r_x, char r_y, short R1, short G1, short B1,
                      int mode, int dir);
    ...
    void draw_magic_ten(VgaBuf *vgabuf, int x1, int y1, int x2, int y2, int mode, int curStep, int totalStep,
                        int delay);
