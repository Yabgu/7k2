...
public:
  ...
  char *setup_years_str(
      int = 0); // return the no. of years this firm has been setup in string
  ...
  static char
      is_being_deleted; // whether the place is currently being deleted, if it
...
public:
  ...
  int locate_space(int removeFirm, int &xLoc, int &yLoc, int xLoc2, int yLoc2,
                   int width, int height, int mobileType = UNIT_LAND,
                   int regionId = 0);
