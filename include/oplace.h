...
class Place : public BaseObj
{
  public:
    ...
    int max_hit_points()
    {
        return (int)place_max_hit_points;
    }

    virtual Place *cast_to_Place()
    {
        return this;
    }
    ...
    static char is_being_deleted; // whether the place is currently being deleted, if it
  ...
  public:
    ...
    int locate_space(int removeFirm, int &xLoc, int &yLoc, int xLoc2, int yLoc2, int width, int height,
    ...
    virtual int return_fire(BaseObj *targetObj)
    {
        return 0;
    }
    virtual float bullet_damage()
    {
        return 0.0f;
    }
    virtual short bullet_radius()
    {
        return 0;
    }
    virtual char bullet_fire()
    {
        return 0;
    }
    virtual short bullet_id()
    {
        return 0;
    }
    virtual short bullet_speed()
    {
        return 0;
    }
    virtual short bullet_init_z()
    {
        return 0;
    }
