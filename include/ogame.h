...
public:
  ...
  void main_menu();
  void
  set_load_game_in_main_menu(char *); // game to load automatically in main_menu
  void
  clear_load_game_in_main_menu(); // game to load automatically in main_menu
  void in_game_menu();
  int in_game_option_menu();
  void game_end(int winNationRecno, int playerDestroyed = 0,
                int surrenderToNationRecno = 0, int retireFlag = 0);
  ...
  void add_win_condition(int condId, int playerOnly, int p1 = 0, int p2 = 0,
                         int yearLimit = 0);
  void del_win_condition(int);
  void add_lose_condition(int condId, int playerOnly, int p1 = 0, int p2 = 0,
                          int yearLimit = 0);
