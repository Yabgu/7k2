...
class Effect : public Sprite
{
  ...
  public:
    ...
    void init(short spriteId, short startX, short startY, char initAction, char initDir, char dispLayer,
              int effectLife);
    void pre_process();
    void process_idle();
    int process_die();
    ...
    static void create(short spriteId, short startX, short startY, char initAction, char initDir, char dispLayer,
                       int effectLife);
};
