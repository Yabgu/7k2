...
class Flame
{
  ...
  public:
    static int grade(int flameStr)
    {
        return (FLAME_GROW_STEP * flameStr) / (20 + flameStr);
    }
    static int default_width(int flameGrade)
    {
        return flameGrade * 8 + 40;
    }
    static int default_height(int flameGrade)
    {
        return flameGrade * 12 + 28;
    }
    static int offset_x(int flameGrade)
    {
        return -4 * flameGrade - 20;
    } // -Flame::default_width/2
    static int offset_y(int flameGrade)
    {
        return -12 * flameGrade - 28;
    } // Flame::default_height
    static int base_width(int flameGrade)
    {
        return flameGrade * 2 + 4;
    }
  ...
  public:
    ...
    void draw_step(short left, short bottom, VgaBuf *vgabuf,
                   short wind); // coordinate of left and bottom
