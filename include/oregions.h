...
#define MIN_STAT_REGION_SIZE                                                   \
  100 // only regions with size >= 100 locations are included in the
      // region_stat_array

#define MAX_REACHABLE_REGION_PER_STAT                                          \
  10 // maximum reachable regions to be kept in RegionStat
