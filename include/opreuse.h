...
private:
  ...
  ReuseNode *
      *cur_paths_head; // points to the head of the path, for smoothing purpose
...
private:
  ...
  void de_occupy_destination(int sx, int sy, int rx1, int ry1, int rx2, int ry2,
                             int i);
  void re_occupy_destination(int sx, int sy, int rx1, int ry1, int rx2, int ry2,
                             int i);
  ReuseNode *search_first_unblocked_node(ReuseNode *&blocked_node, int i);
  ReuseNode *find_path_to_unblocked_node(ReuseNode *blocked_node,
                                         ReuseNode *unblocked_node, int i);
  ReuseNode *search_last_unblocked_node(ReuseNode *blocked_node, int i);
  ReuseNode *search_next_unblocked_from_last_blocked(ReuseNode *blocked_node,
                                                     ReuseNode *node, int i);
