...
enum {
  ...
  K_CHAR_KEY =
      K_IGNORE_NUMPAD | K_IGNORE_SHIFT | K_IGNORE_CAP_LOCK | K_TRANSLATE_KEY,
  K_UNIQUE_KEY = K_IGNORE_SHIFT | K_IGNORE_CTRL | K_IGNORE_ALT |
                 K_IGNORE_NUM_LOCK | K_IGNORE_CAP_LOCK,
};
