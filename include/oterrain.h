...
public:
  ...
  int scan(int nwType, int nwSubType, int neType, int neSubType, int swType,
           int swSubType, int seType, int seSubType, int firstInstance = 0,
           int includeExtra = 0, int special = 0);
  ...
  static char *mask_texture(char *maskPtr, char *tex1, char *tex2,
                            char *outTex = NULL);
