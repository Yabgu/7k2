...
class TechInfo
{
  public:
    ...
    int live_points_cost()
    {
        return race_id < 0 ? complex_level * 20 : 0;
    }
...
class TechRes
{
  public:
    ...
    short tech_count;
    short total_tech_level_array[1 + MAX_RACE]; // the sum of research levels of all
