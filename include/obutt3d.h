...
public:
  ...
  void create(int pX1, int pY1, char buttonStyle, const char *buttonName,
              char elasticFlag = 1, char defIsPushed = 0);

  void create(int pX1, int pY1, const char *upButtonName,
              const char *downButtonName, char elasticFlag = 1,
              char defIsPushed = 0);

  void set_key(unsigned keyCode) { button_key = keyCode; }

  void paint(int pX1, int pY1, char buttonStyle, const char *buttonName,
             char elasticFlag = 1, char defIsPushed = 0) {
