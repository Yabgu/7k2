...
class UnitGroup : public DynArray
{
  ...
  public:
    ...
    void assign(int destXLoc, int destYLoc, int targetMobileType, char remoteAction, int actionNationRecno = -1,
  ...
  private:
    ...
    void run_action(int destXLoc, int destYLoc, int orderId, int orderPara, int actionNationRecno = -1,
                    bool forceMoveFlag = false);
};
