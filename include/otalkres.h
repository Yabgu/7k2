...
public:
  ...
  char *msg_str(int viewingNationRecno, int dispReply = 1,
                int dispSecondLine = 0);
...
public:
  ...
  int ai_send_talk_msg(int toNationRecno, int fromNationRecno, int talkId,
                       int talkPara1 = 0, int talkPara2 = 0, int forceSend = 0,
                       int talkPara3 = 0, int talkPara4 = 0);
