...
class UnitGod : public Unit
{
  public:
    short god_id;
    short base_firm_recno; // recno of the seat of power which creates and
                           // supports this god unit
  ...
  public:
    ...
    void detect_info();
    void disp_hit_point();
    int send_hotkey(unsigned scanCode,
  ...
  protected:
    ...
    /*
            void persian_cast_power(Worker* workerPtr, int nationRecno, int
    divider); void japanese_cast_power(Worker* workerPtr, int nationRecno, int
    divider); void maya_cast_power(Worker* workerPtr, int nationRecno, int
    divider); #ifdef AMPLUS void egyptian_cast_power(Worker *workerPtr, int
    nationRecno, int divider); void indian_cast_power(Worker *workerPtr, int
    nationRecno, int divider); void zulu_cast_power(Worker *workerPtr, int
    nationRecno, int divider); #endif
    */
    //--------- AI functions ----------//
