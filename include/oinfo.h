...
class Info
{
  ...
  public:
    ...
    // ##### begin Gilbert 2/9 #######//
    int draw_unit_icon(int x, int y, int unitId, int nationRecno, int windowX1, int windowY1, int windowX2,
