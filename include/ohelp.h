...
enum
{
    ...
    BRIEF_HELP,
    DETAIL_HELP
}; // for config.help_mode

enum
{
    MAX_HELP_INFO = 200
}; // Maximum no. of help info allowed
...
struct HelpInfo
{
    ...
    char help_code[HELP_CODE_LEN + 1]; // either identify the help message by help
                                       // code or area position
...
class HelpSaveScreen
{
    ...
    char dummy;
    Blob2DW *save_scr_buf; // have a private save screen buffer for displaying the
                           // helpial text
...
class Help
{
  public:
    ...
    enum
    {
        CUSTOM_HELP_TITLE_LEN = 80,
        CUSTOM_HELP_DETAIL_LEN = 200
    };
