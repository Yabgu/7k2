...
public:
  ...
  int detect_button(short x1, short y1, short x2, short y2,
                    const char *buttonName, short buttonRc = -1);
  int allow_mouse_click(short x, short y, short pressOrRelease = -1,
                        short rightOrLeft = -1);
  int allow_button_click(short x1, short y1, short x2, short y2,
                         const char *buttonName, short buttonRc = -1);
  int allow_unit_icon_click(short x1, short y1, UnitInfo *unitInfo,
                            int lightness, short buttonRc = -1);
  ...
  int custom_detect_is_firm_selected(int firmRecno,
                                     int linkedTownNationRecno = -1);
  int custom_detect_is_any_unit_selected(int unitRecno, char orderMode,
                                         char visible, int rankId,
                                         int isCivilian, int isSpy = -1,
                                         int onlyOneSelected = 0);
  ...
  int custom_detect_is_firm_type_selected(int firmId,
                                          int linkedTownNationRecno = -1);
  int custom_search_built_firm(int firmId, int linkedTownNationRecno = -1,
                               int checkWorker = 0);
