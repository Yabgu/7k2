...
class Tutor
{
  ...
  public:
    ...
    int custom_detect_is_any_unit_selected(int unitRecno, char orderMode, char visible, int rankId, int isCivilian,
                                           int isSpy = -1, int onlyOneSelected = 0);
    ...
    int custom_search_independent_town(int startTownRecno, char raceId, int popUpLimit, int popLoLimit,
