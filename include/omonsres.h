...
#define MONSTER_NAME_COUNT                                                     \
  2000 // A maximum of 2000 different monster names in each game
...
struct MonsterRec {
  enum {
    ...
    RANK_LEN = 8,
    NAME_LEN = 20,
    FIRM_BUILD_CODE_LEN = 8,
    UNIT_ID_LEN = 3
  };

  char unit_code[UNIT_CODE_LEN];
  char name[NAME_LEN];
  char level; // the level of the 1-9 monster, the higher the level is, the more
