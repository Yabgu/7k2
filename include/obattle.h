...
class Battle
{
  ...
  public:
    ...
    void create_road();
    int create_unit(int nationRecno, int unitId, int rankId, int nextXLoc1 = -1, int nextYLoc1 = -1, int nextXLoc2 = -1,
                    int nextYLoc2 = -1);
    ...
    int create_firm_next_to_place(Place *placePtr, int firmId, int firmRaceId, int nationRecno = -1,
                                  short distance = 0);
