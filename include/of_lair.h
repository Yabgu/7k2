...
#define MONSTER_COLLECT_TOWN_TRIBUTE_LOYALTY                                   \
  1 // Monster Lairs can collect tribute from the independent towns if their
    // resistance is lower than 30
#define MONSTER_TOWN_TRIBUTE_PER_UNIT                                          \
  5 // The amount of money can be collected per unit from independent towns
...
private:
  ...
  int think_buy_tech();
  int think_tech_to_buy(short *techIdArray, short *techPrefArray,
                        int techCount);
