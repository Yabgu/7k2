...
public:
  ...
  short std_raw_site_count; // standard no. of raw site in one game, based on
                            // this number, new mines pop up when existing mines
                            // run out of deposit
...
public:
  ...
  int add_site(int xLoc, int yLoc, int siteType, int objectId,
               int reserveQty = 0);
