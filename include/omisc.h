...
public:
  ...
  void cal_move_around_a_point(short num, short width, short height,
                               int &xShift, int &yShift);
  void cal_move_around_a_point_v2(short num, short width, short height,
                                  int &xShift, int &yShift);
...
// Return : 1 or 0
//
inline int Misc::is_touch(int x1, int y1, int x2, int y2, int a1, int b1,
                          int a2, int b2) {
