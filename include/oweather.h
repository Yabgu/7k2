...
public:
  ...
  short quake_center_y;

public:
  void init();
  void init_date(short year, short month, short day, short latitude,
                 int quakeFreq);
  ...
  short temp_f();           // temperature in degree F
                            //	short	humidity();				// relative humidity, 0 to
                            //100
...
public:
  ...
  void cast_quake(short x, short y, short radius);
