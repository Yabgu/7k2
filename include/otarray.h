...
template TArray<class T> class TArray {
private:
  T *array_ptr;
  int array_size;
...
template TArray<class T> TArray<T>::TArray(int s)
    : array_ptr(new T[s]), array_size(s) {}
// --------- end of function TArray::TArray --------//

// --------- begin of function TArray::~TArray --------//
template TArray<class T> TArray<T>::~TArray() { delete[] array_ptr; }
// --------- end of function TArray::~TArray --------//
