...
enum // item para_type
{
    ...
    ITEM_PARA_USE_TIMED,    // before use, para is positive. When start using, para
                            // is oppositive negative, and increasing by para_value1.
    ITEM_PARA_CHARGE_TIMED, // similar to USE_TIME_LIMIT, but recover when not
                            // using
};
