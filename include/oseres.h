...
public:
  ...
  SEInfo *operator[](int);
  void sound(short xLoc, short yLoc, short frame, char, short, const char *,
             char = 0, short = 0);
  void far_sound(short xLoc, short yLoc, short frame, char, short, const char *,
                 char = 0, short = 0);

  static int mark_select_object_time(); // return false if this sound should be
                                        // skipped due to too frequent
  static int mark_command_time();       // return false if this sound should be
                                        // skipped due to too frequent
