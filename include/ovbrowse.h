...
typedef void (*BrowDispFP)(int recNo, int x, int y,
...
class VBrowse
{
  ...
  public:
    ...
    virtual void init(int, int, int, int, int, int, int, int, BrowDispFP, int = 1, int = MIN_INTER_SPACE, int = 1);
