...
class BaseObj
{
  public:
    ...
    //	char    	is_ai;              // whether Computer AI control this
    // firm
    // or not
    virtual int is_own();
    ...
    virtual int obj_loc_width()
    {
        return 0;
    }
    virtual int obj_loc_height()
    {
        return 0;
    }

    virtual int obj_loc_x1()
    {
        return 0;
    }
    virtual int obj_loc_y1()
    {
        return 0;
    }
    virtual int obj_loc_x2()
    {
        return 0;
    }
    virtual int obj_loc_y2()
    {
        return 0;
    }

    virtual int obj_mobile_type()
    {
        return 0;
    }
    virtual int obj_is_visible()
    {
        return obj_loc_x1() >= 0;
    }

    virtual int obj_region_id()
    {
        return 0;
    }
    ...
    virtual Unit *cast_to_Unit()
    {
        return 0;
    }
    virtual Firm *cast_to_Firm()
    {
        return 0;
    }
    virtual Town *cast_to_Town()
    {
        return 0;
    }
