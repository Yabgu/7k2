...
class Town : public Place
{
  public:
    ...
    short town_name_id;
    //	char  town_name[TOWN_NAME_LEN+1];		// the user will be able
    // to
    ...
    float received_hit_count;  // no. of received hit by attackers, when this >
    ...
    {
        return possible_defender_combat_level(0);
    }
...
class TownArray : public DynArrayB
{
  ...
  public:
    ...
    int think_town_loc(int maxTries, int &retXLoc, int &retYLoc, int rangeX1 = -1, int rangeY1 = -1, int rangeX2 = -1,
                       int rangeY2 = -1);
