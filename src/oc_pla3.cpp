...
void CampaignEastWest::plot_a3_create_game()
{
    ...
    plot_nation_recno1 =
        nation_array.new_nation(NATION_HUMAN, NATION_AI, RACE_VIKING, nation_array.random_unused_color());
    god_res[GOD_VIKING]->enable_know(plot_nation_recno1);

    plot_nation_recno2 =
        nation_array.new_nation(NATION_HUMAN, NATION_AI, RACE_MONGOL, nation_array.random_unused_color());
...

    {
        ...
        static short neverConsiderArray1[] = {TALK_PROPOSE_TRADE_TREATY, TALK_PROPOSE_FRIENDLY_TREATY,
        ...
        static short neverConsiderArray2[] = {TALK_PROPOSE_ALLIANCE_TREATY, TALK_DECLARE_WAR, TALK_SURRENDER, 0};
        ...
        static short neverConsiderArray3[] = {TALK_PROPOSE_TRADE_TREATY, TALK_PROPOSE_FRIENDLY_TREATY,
...
void CampaignEastWest::plot_a3_next_day()
{
    ...
    if (!nation_array.is_deleted(plot_nation_recno1) && nation_array.is_deleted(plot_nation_recno2))
    {
        ...
        if (!nation_array.is_deleted(plot_enemy_nation_recno))
        {
            ...
            if (nationRelation->status == RELATION_ALLIANCE)
            {
                ...
                nation_array[plot_nation_recno1]->change_ai_relation_level(nation_array.player_recno, +100);
            ...
            {
                if (nationRelation->status == RELATION_FRIENDLY || nationRelation->status == RELATION_NEUTRAL)
                {
        ...
        else
        {
            ...
            talk_res.ai_send_talk_msg(nation_array.player_recno, plot_nation_recno1, TALK_SURRENDER);
