...
// Note : it use the color setting in (vga) and (font_san)
//
void Button::create(int buttonType, int pX1, int pY1, int pX2, int pY2, void *bodyPtr, char pElastic, char defIsPushed,
                    char textCentrePut)
{
...
// Note : it use the color setting in (vga) and (font_san)
//
void Button::create(int buttonType, int pX1, int pY1, int pX2, int pY2, const char *text, char pElastic,
