...
enum
{
    STAGE_14_MONSTER_NATION_RECNO = 2
};
...
int CampaignEastWest::stage_14_create_game()
{
    ...
    create_troop(PLAYER_NATION_RECNO, 66 - campaign_difficulty * 6,
...
int CampaignEastWest::stage_14_create_lair()
{
    ...
    create_lair(cur_monster_nation_recno, STAGE_14_MONSTER_NATION_RECNO, lairAddCount, independentTownAddCount,
