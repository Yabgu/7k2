...
void FirmMine::disp_firm_info(int dispY1, int refreshFlag)
{
    ...
    if (raw_id == 0)
    {
        ...
        font_snds.put_paragraph(INFO_X1 + 20, INFO_Y1 + 38, INFO_X2 - 5, INFO_Y2 - 5, text_firm.str_mine_no_raw());
    }
    else
    {
        ...
        font_snds.center_put(INFO_X1 + 10, INFO_Y1 + 20, INFO_X1 + 96, INFO_Y1 + 45, raw_res[raw_id]->name, 0, 1);
        font_snds.center_put(INFO_X2 - 86 + 12, INFO_Y1 + 20, INFO_X2, INFO_Y1 + 45, raw_res[raw_id]->name, 0, 1);
        ...
        //		str  = "Monthly";
        //		font_snds.center_put( INFO_X1+17, INFO_Y1+90, INFO_X2,
        // INFO_Y1+115,
        // str ); 		str  = "Production"; 		font_snds.center_put( INFO_X1+17,
        // INFO_Y1+106, INFO_X2, INFO_Y1+121, str );
