...
#define REMAP_KEY_COUNT 8
        memcpy(sprite_info->palw_ptr + FIRST_REMAP_KEY, colorRemapTable + FIRST_REMAP_KEY,
...
int Sprite::get_abs_rect(int scrnX, int scrnY, int clipX1, int clipY1, int clipX2, int clipY2, int *rectX1, int *rectY1,
