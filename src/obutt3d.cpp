...
//                       (default : 0)
//
void Button3D::create(int pX1, int pY1, char buttonStyle, const char *buttonName, char elasticFlag, char defIsPushed)
{
    init_flag = 1;
...
//
void Button3D::create(int pX1, int pY1, const char *upButtonName, const char *downButtonName, char elasticFlag,
                      char defIsPushed)
{
    init_flag = 1;
