...
void WorldScanTraverser::remove()
{
    ...
    //		--scan_count;
    //		--traverse_count;		// move backward so next() will
    // advance
    // traverse_count
    //	}
...
static int sort_unit_by_dist1(const void *shortPtr1, const void *shortPtr2)
{
    ...
    return misc.area_distance(sort_center_x1, sort_center_y1, sort_center_x2, sort_center_y2, unitA->obj_loc_x1(),
                              unitA->obj_loc_y1(), unitA->obj_loc_x2(), unitA->obj_loc_y2()) -
           misc.area_distance(sort_center_x1, sort_center_y1, sort_center_x2, sort_center_y2, unitB->obj_loc_x1(),
                              unitB->obj_loc_y1(), unitB->obj_loc_x2(), unitB->obj_loc_y2());
}
// ------ begin of static function sort_unit_by_dist1 -------//
