...
EndConditionInfo EndConditionInfo::end_condition_info[END_CONDITION_COUNT] = {
    {E_DEFEAT_ALL_OTHER_KINGDOMS, E_DEFEAT_OWN_KINGDOM, EW_WIN_ONLY, EP_NONE, EP_NONE, ET_OPTIONAL,
     "Defeat all other Kingdoms"},
    {E_DEFEAT_OWN_KINGDOM, E_DEFEAT_ALL_OTHER_KINGDOMS, EW_LOSE_ONLY, EP_NONE, EP_NONE, ET_OPTIONAL,
     "Your Kingdom is defeated"},
...
void EndCondition::set_condition_str(char *s, int loseCond)
{
    ...
    case E_REACH_POPULATION: // Population reaches <number>
        str = text_end_condition.process(text_end_condition.get_format_str(39, "EC06"), para2);
        break;
    case E_REACH_FRYHTAN: // Fryhtan population reaches <number>
        str = text_end_condition.process(text_end_condition.get_format_str(40, "EC07"), para2);
        break;
    case E_REACH_UNIT_COUNT: // Own <number> of <unit name>(s)
        str = text_end_condition.process(text_end_condition.get_format_str(41, "EC08"), unit_res[para1]->name, para2);
        break;
    case E_REACH_ECONOMY: // Economic score reaches <number>
        str = text_end_condition.process(text_end_condition.get_format_str(42, "EC09"), para2);
        break;
    case E_REACH_MILITARY: // Military score reaches <number>
        str = text_end_condition.process(text_end_condition.get_format_str(43, "EC10"), para2);
        break;
    case E_REACH_TOTAL: // Total score reaches <number>
        str = text_end_condition.process(text_end_condition.get_format_str(44, "EC11"), para2);
        break;
    case E_KILL_MONSTER_SCORE: // Fryhtan battling score reaches <number>
        str = text_end_condition.process(text_end_condition.get_format_str(45, "EC12"), para2);
        break;
    case E_TRAIN_10_GENERAL: // Train 10 Generals of Leadership <number> or above
        str = text_end_condition.process(text_end_condition.get_format_str(46, "EC13"), para2);
        break;
    ...
    case E_CONQUER_TOWN: // Conquer town <town name>
        ...
        str = text_end_condition.process(text_end_condition.get_format_str(63, "EC18"), town_array[para1]->town_name());
        break;
    case E_DESTROY_FIRM: // Destroy <building name>
        // BUGHERE : para1 str may no longer exist
        err_when(firm_array.is_deleted(para1));
        str = text_end_condition.process(text_end_condition.get_format_str(64, "EC19"), firm_array[para1]->firm_name());
        break;
    ...
    case E_ACQUIRE_ITEM: // Acquire item <item name>
        str = text_end_condition.process(text_end_condition.get_format_str(66, "EC21"), item_res.item_name(para1, 0));
        break;
    ...
    case E_ACQUIRE_TECH: // Acquire <technology name> technology
        str = text_end_condition.process(text_end_condition.get_format_str(68, "EC23"), tech_res[para1]->tech_des());
        break;
    ...
    case E_CONQUER_FIRM: // Conquer firm <firm name>
        // BUGHERE : para1 str may no longer exist
        err_when(firm_array.is_deleted(para1));
        str = text_end_condition.process(text_end_condition.get_format_str(70, "EC25"), firm_array[para1]->firm_name());
        break;
    ...
    if (time_limit)
    {
        ...
        str = text_end_condition.process(text_end_condition.get_format_str(77, "ECTM"), (char *)str,
...
int EndCondition::is_condition_true(int nationRecno)
{
    ...
    case E_DEFEAT_OWN_KINGDOM:
        return !nationPtr || (nationPtr->king_unit_recno == 0 && !nationPtr->has_king_successor_candidate());

    case E_DEFEAT_KINGDOM:
        return nation_array.is_deleted(para1);

    case E_FORM_ALLY_WITH_KINGDOM:
        return nationPtr && nationRecno != para1 && nationPtr->get_relation_status(para1) == RELATION_ALLIANCE;
    ...
    case E_REACH_UNIT_COUNT:
        return nationPtr && unit_res[para1]->nation_unit_count_array[nationRecno - 1] +
                                    // ####### begin Gilbert 22/2 ######//
                                    unit_res[para1]->nation_general_count_array[nationRecno - 1] >=
                                para2;
        // ####### end Gilbert 22/2 ######//
    ...
    case E_KEEP_UNIT_ALIVE:
        err_when(!time_limit);
        if (info.game_date - info.game_start_date == time_limit * 365 && !para1_unit_killed)
            return 1;
        return 0;
...
void EndCondition::set_result_str(char *s, int loseCond)
{
    ...
    case E_REACH_POPULATION: // reaches Population of <number>
        str += text_end_condition.process(text_end_condition.get_format_str(84, "ER06"), para2);
        break;
    case E_REACH_FRYHTAN: // reaches Fryhtan Population of <number>
        str += text_end_condition.process(text_end_condition.get_format_str(85, "ER07"), para2);
        break;
    case E_REACH_UNIT_COUNT: // owns <number> <unit name>(s)
        str += text_end_condition.process(text_end_condition.get_format_str(86, "ER08"), unit_res[para1]->name, para2);
        break;
    case E_REACH_ECONOMY: // reaches Economy Score of <number>
        str += text_end_condition.process(text_end_condition.get_format_str(87, "ER09"), para2);
        break;
    case E_REACH_MILITARY: // reaches Military Score of <number>
        str += text_end_condition.process(text_end_condition.get_format_str(88, "ER10"), para2);
        break;
    case E_REACH_TOTAL: // reaches Total Score of <number>
        str += text_end_condition.process(text_end_condition.get_format_str(89, "ER11"), para2);
        break;
    case E_KILL_MONSTER_SCORE: // reaches Fryhtan Battling Score of <number>
        str += text_end_condition.process(text_end_condition.get_format_str(90, "ER12"), para2);
        break;
    case E_TRAIN_10_GENERAL: // has Trained 10 Generals of Leadership <number> or
                             // above
        str += text_end_condition.process(text_end_condition.get_format_str(91, "ER13"), para2);
        break;
    ...
    case E_CONQUER_TOWN: // has Conquered Town <town name>
        ...
        str +=
            text_end_condition.process(text_end_condition.get_format_str(108, "ER18"), town_array[para1]->town_name());
        break;
    case E_DESTROY_FIRM: // has Destroyed <building name>
        ...
        str +=
            text_end_condition.process(text_end_condition.get_format_str(109, "ER19"), firm_array[para1]->firm_name());
        break;
    ...
    case E_ACQUIRE_ITEM: // has Acquired Item <item name>
        str += text_end_condition.process(text_end_condition.get_format_str(111, "ER21"), item_res.item_name(para1, 0));
        break;
    case E_NATION_SURVIVE: // has Survived for <number> Year(s) / cannot Win in
                           // <number> Year(s)
        if (!loseCond)
        {
            str += text_end_condition.process(text_end_condition.get_format_str(112, "ER22"), para2);
        }
        else
        {
            str += text_end_condition.process(text_end_condition.get_format_str(116, "aR22"), para2);
        }
        break;
    case E_ACQUIRE_TECH:
        str += text_end_condition.process(text_end_condition.get_format_str(113, "ER23"), tech_res[para1]->tech_des());
        break;
    ...
    case E_CONQUER_FIRM: // has Conquered Firm <firm name>
        ...
        str +=
            text_end_condition.process(text_end_condition.get_format_str(115, "ER25"), firm_array[para1]->firm_name());
        break;
...
int EndCondition::update_condition_site_taken(int siteRecno, int nationRecno)
{
    ...
    if (EndConditionInfo::end_condition_info[condition_id].para1_type == EP_SITE_RECNO && para1 == siteRecno &&
        !para1_nation_took)
    {
...
int EndCondition::update_condition_item_acquired(short itemId, int nationRecno)
{
    ...
    if (EndConditionInfo::end_condition_info[condition_id].para1_type == EP_ITEM_ID && para1 == itemId &&
        !para1_nation_took)
    {
        para1_nation_took = nationRecno;
        return 1;
