...
void TalkMsg::demand_tribute(int isAid)
{
    ...
    // Hilfe/Tribut an Sie.	     //CAUTION: No more alternating 'give/pay',
    // just only: 'Zahlung'!
    //
...
void TalkMsg::demand_tech()
{
    ...
    char friendRelation = (nation_array[from_nation_recno]->get_relation_status(to_nation_recno)->is_friendly());
