...
static CampaignEastWestFP plot_a_next_day_func_array[PLOT_A_COUNT] = {
    &CampaignEastWest::plot_a1_next_day, &CampaignEastWest::plot_a2_next_day,
    &CampaignEastWest::plot_a3_next_day, &CampaignEastWest::plot_a4_next_day,
    &CampaignEastWest::plot_a5_next_day, &CampaignEastWest::plot_a6_next_day,
...
static CampaignEastWestFP plot_d_next_day_func_array[PLOT_D_COUNT] = {
    &CampaignEastWest::plot_d1_next_day, &CampaignEastWest::plot_d2_next_day,
    &CampaignEastWest::plot_d3_next_day, &CampaignEastWest::plot_d4_next_day,
...
void CampaignEastWest::init_random_plot(char plotCategory) {
  ...
  //			{
  //				plot_create_game_FP = plot_null;		// there is a chance
  ...
  if (misc.random(7) == 0 ||
      funcCount == 0) // 20% chance that this game does not have a plot
  {
    plot_id = 0; // set to zero, in case the condition is changed
    plot_create_game_FP =
        &CampaignEastWest::plot_null; // there is a chance that the plot is
