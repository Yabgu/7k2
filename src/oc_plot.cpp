...
static CampaignEastWestFP plot_a_create_game_func_array[PLOT_A_COUNT] = {
    &CampaignEastWest::plot_a1_create_game, &CampaignEastWest::plot_a2_create_game,
    &CampaignEastWest::plot_a3_create_game, &CampaignEastWest::plot_a4_create_game,
    &CampaignEastWest::plot_a5_create_game, &CampaignEastWest::plot_a6_create_game,
    &CampaignEastWest::plot_a7_create_game,
};

static CampaignEastWestFP plot_a_next_day_func_array[PLOT_A_COUNT] = {
    &CampaignEastWest::plot_a1_next_day, &CampaignEastWest::plot_a2_next_day, &CampaignEastWest::plot_a3_next_day,
    &CampaignEastWest::plot_a4_next_day, &CampaignEastWest::plot_a5_next_day, &CampaignEastWest::plot_a6_next_day,
...
static CampaignEastWestFP plot_d_create_game_func_array[PLOT_D_COUNT] = {
    &CampaignEastWest::plot_d1_create_game, &CampaignEastWest::plot_d2_create_game,
    &CampaignEastWest::plot_d3_create_game, &CampaignEastWest::plot_d4_create_game,
    &CampaignEastWest::plot_d5_create_game,
};

static CampaignEastWestFP plot_d_next_day_func_array[PLOT_D_COUNT] = {
    &CampaignEastWest::plot_d1_next_day, &CampaignEastWest::plot_d2_next_day, &CampaignEastWest::plot_d3_next_day,
    &CampaignEastWest::plot_d4_next_day, &CampaignEastWest::plot_d5_next_day,
};
...
void CampaignEastWest::init_random_plot(char plotCategory)
{
    ...
    //			{
    //				plot_create_game_FP = plot_null;		// there is a
    // chance
    // that the plot is null. That means there is no plot for the game.
    ...
    //				plot_create_game_FP =
    // plot_a_create_game_func_array[plot_id-1]; 				plot_next_day_FP
    // = plot_a_next_day_func_array[plot_id-1];
    //			}
    ...
    if (misc.random(7) == 0 || funcCount == 0) // 20% chance that this game does not have a plot
    {
        ...
        plot_create_game_FP = &CampaignEastWest::plot_null; // there is a chance that the plot is
                                                            // null. That means there is no plot for
                                                            // the game.
