...
static DisplayModeInfo display_info_array[MAX_DISPLAY_MODE_ID] = {
    // 800x600x16
    {
        ...
        598,
        576,
        531 + 12, // zoom_matrix_x1,y1,x2,y2,width,height
        592,
        24,
        791,
        223,
        ...
        0,
        574,
        67 - 12, // top_menu_x1,y1,x2,y2
        576,
        258,
        799,
        583, // info_x1,y1,x2,y2
        586,
        560,
        790,
        ...
        6, // menu_button_x1, y1
        486 - 30,
        24, // repu_button_x1, y1
        480,
        12 - 2,
        105, // date_x1, y1, length
        378 - 20,
        9 + 4,
        67 + 100, // food_x1, y1, length
        376 - 20,
        36 + 1,
        69 + 100, // cash_x1, y1, length
        0,
        0,
        331 - 19,
        66 - 11, // scroll_menu_x1, y1, x2, y2
        577,
        584,
        799,
        599, // help_short_x1, y1, x2, y2
        0,
        0,
        797,
        598 // mouse_x1,y1,x2,y2
    },
