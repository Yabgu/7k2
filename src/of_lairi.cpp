...
void FirmLair::disp_camp_info(int dispY1, int refreshFlag)
{
    ...
    {
        // ######## begin Gilbert 31/12 ######//
        //		button_train.create( INFO_X1+13+BUTTON_DISTANCE*2, INFO_Y1+281,
        //'A', "TRAIN" ); 		button_select_research.create(
    ...
    if (nation_recno)
    {
        if (is_own())
        {
            ...
            button_select_research.enable_flag =
                tech_res.researchable_tech_count(nation_recno, race_id, 0) > 0; // 0-don't check live points
    ...
    else
    {
        ...
        {
            button_grant.enable_flag =
                can_grant_to_non_own_lair(nation_array.player_recno,
...
void FirmLair::disp_grant_menu(int refreshFlag)
{
    ...
    if (!can_grant_to_non_own_lair(nation_array.player_recno, 1))
    {
        ...
        //		font_whbl.center_put_paragraph( INFO_X1 +20 , INFO_Y1 + 80,
        // INFO_X2 -10, INFO_Y1 +100, str, 2, 0, 0 );
