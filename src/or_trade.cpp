...
void Info::disp_trade(int refreshFlag)
{
    ...
    {
        // ###### begin Gilbert 19/10 #######//
        browse_caravan.init(CARAVAN_BROWSE_X1, CARAVAN_BROWSE_Y1 + 22, CARAVAN_BROWSE_X2, CARAVAN_BROWSE_Y2 - 20, 0, 18,
...
static void create_caravan_list()
{
    ...
    for (short unitRecno = 1; unitRecno <= totalUnit; unitRecno++)
    {
        ...
        if (unitPtr->nation_recno == info.viewing_nation_recno && unitPtr->unit_id == UNIT_CARAVAN)
        {
...
static void create_ship_list()
{
    ...
    for (short unitRecno = 1; unitRecno <= totalUnit; unitRecno++)
    {
        ...
        if (unitPtr->nation_recno == info.viewing_nation_recno && unit_res[unitPtr->unit_id]->carry_goods_capacity > 0)
        {
