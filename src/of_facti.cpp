...
void FirmFactory::disp_firm_info(int dispY1, int refreshFlag)
{
    ...
    font_snds.center_put(INFO_X1 + 10, INFO_Y1 + 40, INFO_X1 + 96, INFO_Y1 + 55, misc.format((int)raw_stock_qty));
    ...
    font_snds.center_put(INFO_X2 - 86 + 12, INFO_Y1 + 40, INFO_X2, INFO_Y1 + 55, misc.format((int)stock_qty));
    ...
    if (refreshFlag == INFO_REPAINT)
    {
        ...
        button_auto_switch_group[0].create(
            INFO_X1 + 3 * BUTTON_DISTANCE + 13, INFO_Y1 + 281, INFO_X1 + 3 * BUTTON_DISTANCE + 56 - 1,
            INFO_Y1 + 281 + BUTTON_ACTION_HEIGHT - 1, i_disp_auto_switch_button, ButtonCustomPara(this, 0), 0);

        // auto button
        button_auto_switch_group[1].create(
            INFO_X1 + 2 * BUTTON_DISTANCE + 13, INFO_Y1 + 281, INFO_X1 + 2 * BUTTON_DISTANCE + 56 - 1,
            INFO_Y1 + 281 + BUTTON_ACTION_HEIGHT - 1, i_disp_auto_switch_button, ButtonCustomPara(this, 1), 0);
    }

    help.set_help(INFO_X1 + 3 * BUTTON_DISTANCE + 13, INFO_Y1 + 281, INFO_X1 + 3 * BUTTON_DISTANCE + 56 - 1,
                  INFO_Y1 + 281 + BUTTON_ACTION_HEIGHT - 1, "MANUAL");
    help.set_help(INFO_X1 + 2 * BUTTON_DISTANCE + 13, INFO_Y1 + 281, INFO_X1 + 2 * BUTTON_DISTANCE + 56 - 1,
