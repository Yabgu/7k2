...
void VBrowseIF::init(int inX1, int inY1, int inX2, int inY2, int recWidth, int recHeight, int totalRec,
                     BrowDispFP dispFunc, int dispFrame, int minInterSpace, int dispFrameRect)
{
    VBrowse::init(inX1, inY1, inX2, inY2, 0, recWidth, recHeight, totalRec, dispFunc, dispFrame, minInterSpace,
                  dispFrameRect);
