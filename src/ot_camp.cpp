...
void TextResCampaign::init() { TextResource::init(DIR_RES "T_CAMP.RES"); }
...
char *TextResCampaign::str_intro_1() { return get_format_str(10, "ITR1"); }

// text id 11
// [ITR2]An Empire lost and Pain and Scorn and Death endured
char *TextResCampaign::str_intro_2() { return get_format_str(11, "ITR2"); }

// text id 12
// [ITR3]Naught but Years of Torment are assured
char *TextResCampaign::str_intro_3() { return get_format_str(12, "ITR3"); }

// text id 13
// [ITR4]Before your Foes can you repay
char *TextResCampaign::str_intro_4() { return get_format_str(13, "ITR4"); }

// text id 14
// [ITR5]Now rouse a host and take the field
char *TextResCampaign::str_intro_5() { return get_format_str(14, "ITR5"); }

// text id 15
// [ITR6]Choose men of whom canst boast
char *TextResCampaign::str_intro_6() { return get_format_str(15, "ITR6"); }

// text id 16
// [ITR7]Did pledge their Liege, their Lives their Ghost
char *TextResCampaign::str_intro_7() { return get_format_str(16, "ITR7"); }

// text id 17
// [ITR8]And forced all else to yield
char *TextResCampaign::str_intro_8() { return get_format_str(17, "ITR8"); }
...
char *TextResCampaign::str_victory_1() { return get_format_str(22, "VIC1"); }

// text id 23
// [VIC2]Though men of steel and steeds of gray
char *TextResCampaign::str_victory_2() { return get_format_str(23, "VIC2"); }

// text id 24
// [VIC3]Stood hard and fast and barred your way
char *TextResCampaign::str_victory_3() { return get_format_str(24, "VIC3"); }

// text id 25
// [VIC4]Yet tis you to who all heads now bow
char *TextResCampaign::str_victory_4() { return get_format_str(25, "VIC4"); }

// text id 26
// [VIC5]Against foes both Beast and Man
char *TextResCampaign::str_victory_5() { return get_format_str(26, "VIC5"); }

// text id 27
// [VIC6]you stood beneath your Flag Unfurled
char *TextResCampaign::str_victory_6() { return get_format_str(27, "VIC6"); }

// text id 28
// [VIC7]They numbered as the Grains of Stand
char *TextResCampaign::str_victory_7() { return get_format_str(28, "VIC7"); }

// text id 29
// [VIC8]In the Dead Seas and the Desert Land
char *TextResCampaign::str_victory_8() { return get_format_str(29, "VIC8"); }
...
// text id 33
// [SCOR]Score
char *TextResCampaign::str_score() { return get_format_str(33, "SCOR"); }
...
// text id 37
// [BONF]That is %1d, minus the number of years that it took to achieve the
// goal.
...
// text id 39
// [ROYU]Royal Units
char *TextResCampaign::str_royal_units() { return get_format_str(39, "ROYU"); }

// text id 40
// [RHLP]Check the units that you wish to use in this scenario. You may Click on
// an Artifact and move it to another unit.
...
// text id 42
// [DONE]Done
char *TextResCampaign::str_done() { return get_format_str(42, "DONE"); }

// text id 43
// [REST]Restore
char *TextResCampaign::str_restore() { return get_format_str(43, "REST"); }
...
// text id 45
// [DALL]Deselect All
char *TextResCampaign::str_deselect_all() { return get_format_str(45, "DALL"); }

// text id 46
// [DELR]Delete
char *TextResCampaign::str_delete_royal() { return get_format_str(46, "DELR"); }

// text id 47
// [HU_F]Human Only
char *TextResCampaign::str_human_force() { return get_format_str(47, "HU_F"); }
...
char *TextResCampaign::str_ask_fryhtan() { return get_format_str(49, "ASKF"); }
...
char *TextResCampaign::str_state_of_cnation(char *cNationName) {
  return process(get_format_str(72, "STON"), cNationName);
}
...
char *TextResCampaign::str_victory_9() { return get_format_str(76, "VIC9"); }
