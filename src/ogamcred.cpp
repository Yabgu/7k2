...
static void disp_credits_2()
{
        ...
        static char* credit_name_array[] =
        {
                ...
                "Brain K. Davis VII",
                "Arnold Hendrick",
                "Sarah O'Keefe and Alan Pringle von 'Scriptorium Publishing
Services, Inc.", "Angela Lipscomb",
        };
...
"Interactive Magic" ); y+=font_bible.height()+20;

        for( int i=0 ; credit_des_array[i] ; i++ )
        {
                font_bible.center_put( 0, y, VGA_WIDTH-1,
y+font_bible.height()-1, credit_des_array[i] ); y+=font_bible.height()+3;

                font_bible.center_put( 0, y, VGA_WIDTH-1,
y+font_bible.height()-1, credit_name_array[i] ); y+=font_bible.height()+16;
        }
}
...
static void disp_credits(int y, char** creditNameArray)
{
        ...
        for( int i=0 ; creditNameArray[i] ; )
        {
                ...
                font_bible.center_put( 0, y, VGA_WIDTH-1,
y+font_bible.height()-1, str ); y+=font_bible.height()+3;
        }
}
