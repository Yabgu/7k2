...
WavStream::WavStream() { this->clear(); }

WavStream::~WavStream() { this->close(); }
...
int32_t WavStream::frame_rate() const { return this->fram_rate; }

int WavStream::channels() const { return this->chans; }

int WavStream::sample_size() const { return this->bytes; }
