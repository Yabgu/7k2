...
void ScenarioEditor::disp_players_main(int refreshFlag)
{
    ...
    {
        browse_nation.init(INFO_X1, INFO_Y1, INFO_X2, INFO_Y1 + 168, -1, 32, MAX_NATION, disp_nation_rec);
    ...
    if (refreshFlag == INFO_REPAINT)
    {
        ...
        //		button_adjustment[0].create_text( INFO_X1+152, y, INFO_X1+214,
        // y+18,
        // text_editor.str_fine_coarse(0) ); // "Fine" );
        //		button_adjustment[1].create_text( INFO_X1+152, y+20,
        // INFO_X1+214,
        // y+38, text_editor.str_fine_coarse(1) ); // "Medium" );
        //		button_adjustment[2].create_text( INFO_X1+152, y+40,
        // INFO_X1+214,
    ...
    if (refreshFlag == INFO_REPAINT)
    {
        button_adjustment[0].create_text(INFO_X1 + 147, y + 18, INFO_X1 + 216, y + 38,
                                         text_editor.str_fine_coarse(0)); // "Fine" );
        button_adjustment[1].create_text(INFO_X1 + 76, y + 18, INFO_X1 + 145, y + 38,
                                         text_editor.str_fine_coarse(1)); // "Medium" );
        button_adjustment[2].create_text(INFO_X1 + 5, y + 18, INFO_X1 + 74, y + 38,
    ...
    if (refreshFlag == INFO_REPAINT)
    {
        //		button_player_type[0].create_text( INFO_X1+50, y, INFO_X1+100,
        // y+18,
        //"Either" ); 		button_player_type[1].create_text( INFO_X1+50, y,
        // INFO_X1+100,
        // y+18, "Computer" );
    }
    if (!nation_array.is_deleted(brush_player_recno))
    {
        //		button_player_type.paint(
        // nation_array[brush_player_recno]->is_ai()
        //);
    }
}
...
void ScenarioEditor::detect_players_main()
{
    ...
    if (mouse.single_click(INFO_X1 + 5, y, INFO_X2 - 5, y + 8 + font_cara_w.max_font_height))
    {
        ...
        nation_name_field.init(INFO_X1 + 5 + lrMargin, y + yOffs, INFO_X2 - 5 - lrMargin, nationStr, FIELD_LEN,
                               &font_cara_w, 1, 1);
