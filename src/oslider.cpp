...
//
void Slider::init(int x1, int y1, int barWidth, int sliderHeight, int barColor, int *varPtr, int maxValue, int stdValue,
                  int barColor2)
{
    slider_x1 = x1;
    slider_y1 = y1;
...
void Slider::refresh()
{
    ...
    if (barWidth > 0)
    {
        ...
        else
        {
            ...
            Vga::active_buf->bar(slider_x1 + 2, slider_y1 + 2, slider_x1 + 1 + barWidth, slider_y2 - 2, bar_color);
        }
    }
    ...
    if (barWidth < bar_width)
    {
        ...
        Vga::active_buf->bar(slider_x1 + 2 + barWidth, slider_y1 + 2, slider_x2 - 2, slider_y2 - 2,
                             Vga::active_buf->color_down);
    }
