...
void TextResEditor::init() { TextResource::init(DIR_RES "T_SEDIT.RES"); }
...
// text id 15
// [BLKM]Blacken Map
char *TextResEditor::str_blacken_map() { return get_format_str(15, "BLKM"); }

// text id 16
// [SCEM]Scenario Editor Menu
char *TextResEditor::str_editor_menu() { return get_format_str(16, "SCEM"); }

// text id 17
// [UNIT]Unit
char *TextResEditor::str_unit() { return get_format_str(17, "UNIT"); }

// text id 18
// [STRU]Structure
char *TextResEditor::str_structure() { return get_format_str(18, "STRU"); }

// text id 19
// [HUMA]Human
char *TextResEditor::str_human() { return get_format_str(19, "HUMA"); }

// text id 20
// [RTWN]%1s town
char *TextResEditor::str_race_town(char *raceAdj) {
  return process(get_format_str(20, "RTWN"), raceAdj);
}

// text id 21
// [ALLR]All
char *TextResEditor::str_all() { return get_format_str(21, "ALLR"); }

// text id 22
// [NOIN]Cannot add any Independent structures
char *TextResEditor::str_no_independent() { return get_format_str(22, "NOIN"); }

// text id 23
// [NOHU]Human Kingdom cannot possess Fryhtan structure
char *TextResEditor::str_no_human() { return get_format_str(23, "NOHU"); }
...
// text id 73
// [PFOO]Food
char *TextResEditor::str_player_food() { return get_format_str(73, "PFOO"); }
...
// text id 76
// [KNAM]King Name
char *TextResEditor::str_king_name() { return get_format_str(76, "KNAM"); }
...
// text id 80
// [DISB](Disabled)
char *TextResEditor::str_player_disable() { return get_format_str(80, "DISB"); }

// text id 81
// [ADD_]Add
char *TextResEditor::str_add() { return get_format_str(81, "ADD_"); }

// text id 82
// [DELE]Delete
char *TextResEditor::str_delete() { return get_format_str(82, "DELE"); }

// text id 83
// [REQA]All conditions are true
char *TextResEditor::str_require_all() { return get_format_str(83, "REQA"); }

// text id 84
// [NEXT]Next
char *TextResEditor::str_next() { return get_format_str(84, "NEXT"); }

// text id 85
// [CNCL]Cancel
char *TextResEditor::str_cancel() { return get_format_str(85, "CNCL"); }

// text id 86
// [DUYR]%1d %1p{year|years}
char *TextResEditor::str_time_limit(int years) {
  return process(get_format_str(86, "DUYR"), years);
}

// text id 87
// [NOLM]No time limit
char *TextResEditor::str_no_time_limit() { return get_format_str(87, "NOLM"); }

// text id 88
// [BACK]Back
char *TextResEditor::str_back() { return get_format_str(88, "BACK"); }

// text id 89
// [SELN]Select target nation by selecting any object of that nation
char *TextResEditor::str_select_nation() { return get_format_str(89, "SELN"); }

// text id 90
// [SELU]Select target unit
char *TextResEditor::str_select_unit() { return get_format_str(90, "SELU"); }
...
char *TextResEditor::str_select_town() { return get_format_str(92, "SELT"); }
...
char *TextResEditor::str_select_firm() { return get_format_str(94, "SELB"); }
...
char *TextResEditor::str_select_item() { return get_format_str(96, "SELI"); }

// text id 97 - 104 reserved

// text id 105
// [HINF]Infantry
char *TextResEditor::str_hero_infantry() { return get_format_str(105, "HINF"); }

// text id 106
// [HSPU]Special
char *TextResEditor::str_hero_spu() { return get_format_str(106, "HSPU"); }

// text id 107
// [PADJ]Adjustment:
char *TextResEditor::str_adjustment() { return get_format_str(107, "PADJ"); }
...
char *TextResEditor::str_relation_inst() { return get_format_str(114, "RELI"); }

// text id 115
// [BVIC]Victory
char *TextResEditor::str_victory() { return get_format_str(115, "BVIC"); }

// text id 116
// [BLOS]Loss
char *TextResEditor::str_loss() { return get_format_str(116, "BLOS"); }

// text id 117
// [REQO]Any Condition is true
char *TextResEditor::str_require_any() { return get_format_str(117, "REQO"); }

// text id 118
// [DDLN]Time Limit:
char *TextResEditor::str_deadline() { return get_format_str(118, "DDLN"); }
