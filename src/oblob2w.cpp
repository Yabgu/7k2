...
void Blob2DW::fill_area(short x1, short y1, short x2, short y2, short color, int autoExtend)
{
    if (autoExtend)
    {
    ...
    IMGbar(ptr->get_ptr(), ptr->get_true_pitch(), x1 - left_edge, y1 - top_edge, x2 - left_edge, y2 - top_edge, color);
    // int y = y1;
