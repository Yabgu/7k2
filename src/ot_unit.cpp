...
void TextResUnit::init() { TextResource::init(DIR_RES "T_UNIT.RES"); }
...
// text id 6
// [FS_N]Croul %1s
const char *TextResUnit::str_unit_titled(int raceId, const char *baseName,
                                         int rankId) {
  if (raceId == 0)
...
// text id 14
// [RS_N]Rebel %1s
const char *TextResUnit::str_rebel_unit_titled(int raceId, const char *baseName,
                                               int rankId) {
  switch (rankId) {
  case RANK_SOLDIER:
...
// text id 21
// [COMB]Combat Level
char *TextResUnit::str_combat_level() { return get_format_str(21, "COMB"); }

// text id 22
// [LEAD]Leadership
char *TextResUnit::str_leadership() { return get_format_str(22, "LEAD"); }

// text id 23
// [HITP]Hit Points
char *TextResUnit::str_hit_points() { return get_format_str(23, "HITP"); }

// text id 24
// [LOYL]Loyalty
char *TextResUnit::str_loyalty() { return get_format_str(24, "LOYL"); }

// text id 25 (spy skill)
// [SPYS]Spying
char *TextResUnit::str_spy_skill() { return get_format_str(25, "SPYS"); }

// text id 26
// [HERO]Hero
char *TextResUnit::str_hero() { return get_format_str(26, "HERO"); }
...
// text id 41
// [CARM]Manual Trade
char *TextResUnit::str_caravan_manual() { return get_format_str(41, "CARM"); }

// text id 42
// [CARA]Auto Trade
char *TextResUnit::str_caravan_auto() { return get_format_str(42, "CARA"); }
...
char *TextResUnit::str_race_defender(int raceId, char *raceAdj) {
  return process(get_format_str(60, "RDEF"), raceAdj);
}
...
char *TextResUnit::str_race_wagon(char *raceAdj, int nameId) {
  return process(get_format_str(63, "RWAG"), raceAdj, nameId);
}
...
char *TextResUnit::str_race_civilian(int raceId, char *raceAdj) {
  return process(get_format_str(66, "RCIV"), raceAdj);
}
...
const char *TextResUnit::str_unit_desc(const char *relationStr,
                                       const char *descStr) {
  if (relationStr && relationStr[0])
    return process(get_format_str(70, "UNRD"), relationStr, descStr);
  else
    return descStr;
}
...
const char *TextResUnit::str_king_s_unit(const char *kingName,
                                         const char *unitName) {
  return process(get_format_str(71, "KUNM"), kingName, unitName);
}

// text id 72
// [BLDI]Please select a location to build the %1s.
char *TextResUnit::str_select_build(char *firmName) {
  return process(get_format_str(72, "BLDI"), firmName);
}

// text id 73
// [(cost $? + ? life points)BLDC]cost %1,2d%2?{ + |}%2z%2?{ life points|}
char *TextResUnit::str_build_cost(int buildCost, int buildLive) {
  return process(get_format_str(73, "BLDC"), buildCost, buildLive);
}

// text id 74
// [SETT]Please select a location to settle.
char *TextResUnit::str_select_settle() { return get_format_str(74, "SETT"); }

// text id 75
// [SPYC]Spy Cloak
char *TextResUnit::str_spy_cloak() { return get_format_str(75, "SPYC"); }

// text id 76
// [NOCC]Enemies Nearby !! Cannot change cloak.
char *TextResUnit::str_no_change_cloak() { return get_format_str(76, "NOCC"); }

// text id 77
// [IDRP]Right click to drop
char *TextResUnit::str_item_drop() { return get_format_str(77, "IDRP"); }

// text id 78
// [IUSE]use
char *TextResUnit::str_item_use() { return get_format_str(78, "IUSE"); }

// text id 79
// [I_ON]on
char *TextResUnit::str_item_on() { return get_format_str(79, "I_ON"); }

// text id 80
// [IOFF]off
char *TextResUnit::str_item_off() { return get_format_str(80, "IOFF"); }

// text id 81
// [RTRI]Automatically Retreat this (Left-click) or all your Generals
// (Right-click) to Home Fort when hit point is below :
...
// text id 82
// [DISA]DISABLE
char *TextResUnit::str_disable_auto() { return get_format_str(82, "DISA"); }

// text id 83
// [HIRH]%1s will take your color for %2,2d. Hire him now?
char *TextResUnit::str_ask_hire(const char *name, int price) {
  return process(get_format_str(83, "HIRH"), name, price);
}

// text id 84
// [HIF1]But you do not have enough money now.
char *TextResUnit::str_fail_hire_cash() { return get_format_str(84, "HIF1"); }

// text id 85
// [HIF2]But he has been hired by other nation.
char *TextResUnit::str_fail_hire_late() { return get_format_str(85, "HIF2"); }

// text id 86
// [HIF3]Hire failed.
char *TextResUnit::str_fail_hire() { return get_format_str(86, "HIF3"); }

// text id 87
// [ITUU]Left click on target unit
char *TextResUnit::str_use_item_on_unit() { return get_format_str(87, "ITUU"); }

// text id 88
// [ITUT]Left click on target town
char *TextResUnit::str_use_item_on_town() { return get_format_str(88, "ITUT"); }

// text id 89
// [ITUP]Left click target position
char *TextResUnit::str_use_item_on_pos() { return get_format_str(89, "ITUP"); }

// text id 90
// [ITEM]Item
char *TextResUnit::str_item() { return get_format_str(90, "ITEM"); }

// text id 91
// [LINC]Left click to increase
char *TextResUnit::str_left_inc() { return get_format_str(91, "LINC"); }

// text id 92
// [RINC]Right click to increase
char *TextResUnit::str_right_dec() { return get_format_str(92, "RINC"); }

// text id 93
// [e.g. King Jaguar 3 or Catapult III 6 NRNM]%4?{King |}%1s%2?{ |}%2r%3?{ |}%3z
char *TextResUnit::str_non_race_unit_name(const char *unitName, int version,
                                          int serial, int kingAnimal) {
  if (version == 1)
    version = 0; // suppress if version 1

  return process(get_format_str(93, "NRNM"), unitName, version, serial,
                 kingAnimal);
}
...
char *TextResUnit::str_hero_titled(int raceId, const char *baseName) {
  return process(get_format_str(94, "HERU"), baseName);
}
