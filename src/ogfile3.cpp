...
{
    return write_with_record_size(filePtr, this, &visit_bullet<FileWriterVisitor>, BULLET_RECORD_SIZE);
}
...
{
    if (!read_with_record_size(filePtr, this, &visit_bullet<FileReaderVisitor>, BULLET_RECORD_SIZE))
        return 0;
...
template <typename Visitor> static void visit_projectile(Visitor *v, Projectile *p)
{
...
{
    return write_with_record_size(filePtr, this, &visit_projectile<FileWriterVisitor>, PROJECTILE_RECORD_SIZE);
}
...
{
    if (!read_with_record_size(filePtr, this, &visit_projectile<FileReaderVisitor>, PROJECTILE_RECORD_SIZE))
        return 0;
...
template <typename Visitor> static void visit_nation_array(Visitor *v, NationArray *na)
{
...
int NationArray::write_file(File *filePtr)
{
    ...
    if (!write_with_record_size(filePtr, this, &visit_nation_array<FileWriterVisitor>, NATION_ARRAY_RECORD_SIZE))
        return 0;
...
int NationArray::read_file(File *filePtr)
{
    ...
    if (!read_with_record_size(filePtr, this, &visit_nation_array<FileReaderVisitor>, NATION_ARRAY_RECORD_SIZE))
        return 0;
...
template <typename Visitor> static void visit_nation_relation(Visitor *v, NationRelation *nr)
{
...
template <typename Visitor> static void visit_ai_region(Visitor *v, AIRegion *reg)
{
...
template <typename Visitor> static void visit_attack_camp(Visitor *v, AttackCamp *ac)
{
...
{
    if (!write_with_record_size(filePtr, this, &visit_nation<FileWriterVisitor>, NATION_RECORD_SIZE))
        return 0;
...
int Nation::read_file(File *filePtr)
{
    ...
    if (!read_with_record_size(filePtr, this, &visit_nation<FileReaderVisitor>, NATION_RECORD_SIZE))
        return 0;
...
{
    return write_with_record_size(filePtr, this, &visit_tornado<FileWriterVisitor>, TORNADO_RECORD_SIZE);
}
...
{
    if (!read_with_record_size(filePtr, this, &visit_tornado<FileReaderVisitor>, TORNADO_RECORD_SIZE))
        return 0;
...
template <typename Visitor> static void visit_region_array(Visitor *v, RegionArray *ra)
{
...
{
    if (!write_with_record_size(filePtr, this, &visit_region_array<FileWriterVisitor>, REGION_ARRAY_RECORD_SIZE))
        return 0;
...
int RegionArray::read_file(File *filePtr)
{
    ...
    if (!read_with_record_size(filePtr, this, &visit_region_array<FileReaderVisitor>, REGION_ARRAY_RECORD_SIZE))
        return 0;
