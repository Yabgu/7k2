...
void FirmIncubator::disp_war_info(int dispY1, int refreshFlag)
{
    ...
    else
    {
        ...
        info.draw_unit_icon(INFO_X1 + 53, INFO_Y1 + 110, build_unit_id, nation_recno, INFO_X1 + 12, INFO_Y1 + 55,
                            INFO_X2, INFO_Y2, 1);
...
void FirmIncubator::disp_build_menu(int refreshFlag)
{
    ...
    for (int i = 0; i < MAX_INCUBATE_TYPE; ++i)
    {
        ...
        button_weapon[added_count].visible_flag = button_queue_weapon[added_count].visible_flag =
