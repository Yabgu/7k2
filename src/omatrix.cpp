...
//                                     animation
//
void Matrix::init(int winX1, int winY1, int winX2, int winY2, int areaWidth, int areaHeight, float locXWidth,
                  float locXHeight, float locYWidth, float locYHeight, char dispRecType, int saveAreaToBuf)
{
