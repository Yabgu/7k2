...
enum
{
    STAGE_7_MONSTER_NATION_RECNO = 2
};
...
int CampaignEastWest::stage_7_create_game()
{
    ...
    create_troop(PLAYER_NATION_RECNO, 33 - campaign_difficulty * 3,
                 80); // 80 - average combat level, an elite force
...
int CampaignEastWest::stage_7_create_lair()
{
    ...
    create_lair(cur_monster_nation_recno, STAGE_7_MONSTER_NATION_RECNO, lairAddCount, independentTownAddCount,
                specialFirmCount);
