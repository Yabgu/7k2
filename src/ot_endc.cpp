...
void TextResEndCondition::init() { TextResource::init(DIR_RES "T_ENDC.RES"); }
...
// text id 124
// [YOUR]Your %1s
char *TextResEndCondition::str_you_win_str(int nationRaceId,
                                           char *resultFormatStr) {
  String tempStr;
  // to format Your Kingdom / Your Kwyzan
  tempStr =
      process(get_format_str(124, "YOUR"), text_unit.str_nation(nationRaceId));

  return process(resultFormatStr, (char *)tempStr);
}

char *TextResEndCondition::str_other_win_str(char *winNationName,
                                             char *resultFormatStr) {
...
char *TextResEndCondition::str_lose_surrender(char *targetNationName,
                                              char *dateStr) {
...
char *TextResEndCondition::str_you_lose_str(int nationRaceId,
                                            char *resultFormatStr) {
  String tempStr;
  // to format Your Kingdom / Your Kwyzan
  tempStr =
