...
// <int>    = the no. of characters to copied.        (default:to the end of the
// string)
//
...
// [int]   roundDirection = 0-if <= 4, round to a smaller, if >=5 round to a
// bigger
...
//----------Begin of function Misc::area_distance -----------//
//
...
//------- Begin of function Misc::chance ---------//
//
// <int> testChance - the chance to test.
//
...
//------- Begin of function Misc::abs_direction_diff ---------//
//
