...
//0)
//
char *TalkMsg::msg_str(int viewingNationRecno, int dispReply,
                       int dispSecondLine) {
  ...
  */
  ...
  if (reply_type == REPLY_WAITING || !should_disp_reply) {
    if (viewing_nation_recno == from_nation_recno)
      ...
      str =
          text_talk.process(text_talk.get_format_str(54, "NPDW"),
                            from_nation_name(), third_nation_name(talk_para1));
  } else {
    if (viewing_nation_recno == from_nation_recno)
      if (reply_type == REPLY_ACCEPT)
        str =
            text_talk.process(text_talk.get_format_str(55, "NADW"),
                              to_nation_name(), third_nation_name(talk_para1));
      else
        str =
            text_talk.process(text_talk.get_format_str(56, "NRDW"),
                              to_nation_name(), third_nation_name(talk_para1));
    else if (reply_type == REPLY_ACCEPT)
      str =
          text_talk.process(text_talk.get_format_str(57, "YADW"),
                            from_nation_name(), third_nation_name(talk_para1));
    else
      str =
          text_talk.process(text_talk.get_format_str(58, "YRDW"),
                            from_nation_name(), third_nation_name(talk_para1));
  }
}
  ...
  if (reply_type == REPLY_WAITING || !should_disp_reply) {
    ...
    if (viewing_nation_recno == from_nation_recno)
      str = text_talk.process(text_talk.get_format_str(93, "YPXT"),
                              to_nation_name(),
                              tech_res[talk_para1]->tech_des(), talk_para3,
  ...
  */
  ...
  if (reply_type == REPLY_WAITING || !should_disp_reply) {
    if (viewing_nation_recno == from_nation_recno)
      ...
      str =
          text_talk.process(text_talk.get_format_str(42, "NPTE"),
                            from_nation_name(), third_nation_name(talk_para1));
  } else {
    if (viewing_nation_recno == from_nation_recno)
      if (reply_type == REPLY_ACCEPT)
        str =
            text_talk.process(text_talk.get_format_str(43, "NATE"),
                              to_nation_name(), third_nation_name(talk_para1));
      else
        str =
            text_talk.process(text_talk.get_format_str(44, "NRTE"),
                              to_nation_name(), third_nation_name(talk_para1));
    else if (reply_type == REPLY_ACCEPT)
      str =
          text_talk.process(text_talk.get_format_str(45, "YATE"),
                            from_nation_name(), third_nation_name(talk_para1));
    else
      str =
          text_talk.process(text_talk.get_format_str(46, "YRTE"),
                            from_nation_name(), third_nation_name(talk_para1));
  }
}
...
void TalkMsg::request_surrender() {
  ...
  */
  ...
  if (reply_type == REPLY_WAITING || !should_disp_reply) {
    if (viewing_nation_recno == from_nation_recno)
      str = text_talk.process(
          text_talk.get_format_str(99, "YPRS"), to_nation_name(),
          talk_para1 * 10); // talk_para1*10 to restore its original value.
    else
      str = text_talk.process(
          text_talk.get_format_str(100, "NPRS"), from_king_name(),
          talk_para1 * 10); // talk_para1*10 to restore its original value.
  } else {
    if (viewing_nation_recno == from_nation_recno)
      if (reply_type == REPLY_ACCEPT)
