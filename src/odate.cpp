...
static char month_str_array[][10] = {"January", "February", "March",     "April",   "May",      "June",
                                     "July",    "August",   "September", "October", "November", "December"};

static int month_tot[] = {0, 0, 31, 59, 90, 120, 151, 181, 212, 243, 273, 304, 334, 365};
...
{
    return julian(misc.atoi(dateStr, 4), misc.atoi(dateStr + 4, 2), misc.atoi(dateStr + 6, 2));
}
//---------- End of function DateInfo::julian ----------//
