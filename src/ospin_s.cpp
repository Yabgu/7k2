...
void SpinnerSmall::create(int x1, int y1, int x2, int y2, int vbrowseHeight,
                          int minRec, int recCount, SpinDispFP funcPtr,
                          int recNo) {
  min_rec_num = minRec;
  ...
  button_up.create(ox2 - SCROLL_BUTTON_WIDTH + 1, oy1 + 2, "TRI-U-UP",
                   "TRI-U-DW");
  button_down.create(ox2 - SCROLL_BUTTON_WIDTH + 1, oy2 - buttonHeight + 1 - 2,
                     "TRI-D-UP", "TRI-D-DW");
