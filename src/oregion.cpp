...
RegionArray::RegionArray() { init_flag = 0; }
// --------- End of function RegionArray::RegionArray -------//

// --------- Begin of function RegionArray::~RegionArray -------//
RegionArray::~RegionArray() { deinit(); }
// --------- End of function RegionArray::~RegionArray -------//
...
void RegionArray::sort_region() {
  ...
  qsort(region_sorted_array, region_info_count, sizeof(region_sorted_array[0]),
        sort_region_function);
}
...
//
static int sort_region_function(const void *a, const void *b) {
  return region_array[*((BYTE *)b)]->region_size -
         region_array[*((BYTE *)a)]->region_size;
}
