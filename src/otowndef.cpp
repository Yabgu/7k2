...
{
    if (population <= 1) // do not call out defenders any more if there is only one unit left in
    ...
    unitPtr->skill.set_skill_level((int)loyaltyDec); // if the unit is a town defender, this var is temporary
