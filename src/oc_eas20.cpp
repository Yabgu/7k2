...
int CampaignEastWest::stage_20_create_town() {
  ...
  return create_town(STAGE_20_EASTERN_NATION_RECNO, townAddCount,
                     hasFortPercent);
}
...
int CampaignEastWest::stage_20_create_firm() {
  ...
  int townRecno2 = random_pick_town_with_camp(
      STAGE_20_EASTERN_NATION_RECNO, 2); // only pick towns with <= 2 links
