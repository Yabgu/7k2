...
enum
{
    STAGE_10_MONSTER_NATION_RECNO = 2
};
...
int CampaignEastWest::stage_10_create_game()
{
    ...
    create_troop(PLAYER_NATION_RECNO, 65 - campaign_difficulty * 5,
                 75); // 70 - average combat level, an elite force
...
int CampaignEastWest::stage_10_create_lair()
{
    ...
    create_lair(cur_monster_nation_recno, STAGE_10_MONSTER_NATION_RECNO, lairAddCount, independentTownAddCount,
                specialFirmCount);
