...
static const char *music_file[] = {
    "CBRIEF.WAV", // opening
    "CFRYWIN.WAV",  "MENU.WAV",     "LOSE.WAV",     "WIN.WAV",      "BKMUSIC1.WAV", "BKMUSIC2.WAV",
    "BKMUSIC3.WAV", "BKMUSIC4.WAV", "BKMUSIC5.WAV", "BKMUSIC6.WAV", "BKMUSIC7.WAV",
};
...
int Music::play(int songId, int playType)
{
    ...
    {
        if (audio.cd_init_flag && audio.play_cd(songId + 1,
