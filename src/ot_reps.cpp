...
void TextResReports::init() { TextResource::init(DIR_RES "T_REPS.RES"); }

// text id 1
// [POPU]Population
char *TextResReports::str_population() { return get_format_str(1, "POPU"); }

// text id 2
// [MILI]Military
char *TextResReports::str_military() { return get_format_str(2, "MILI"); }

// text id 3
// [ECON]Economy
char *TextResReports::str_economy() { return get_format_str(3, "ECON"); }

// text id 4
// [REPU]Reputation
char *TextResReports::str_reputation() { return get_format_str(4, "REPU"); }
...
// text id 7
// [MILS]Military Score
char *TextResReports::str_military_score() { return get_format_str(7, "MILS"); }

// text id 8
// [ECOS]Economic Score
char *TextResReports::str_economy_score() { return get_format_str(8, "ECOS"); }
...
// text id 11
// [TOTS]Total Score
char *TextResReports::str_total_score() { return get_format_str(11, "TOTS"); }

// text id 12
// [FINS]Final Score
char *TextResReports::str_final_score() { return get_format_str(12, "FINS"); }
...
// text id 15
// [CHEA]Cheated
char *TextResReports::str_cheated() { return get_format_str(15, "CHEA"); }
...
char *TextResReports::str_duration_hm(int hours, int minutes) {
  return process(get_format_str(20, "DUHM"), hours, minutes);
}
...
// text id 39
// [NKIN]Kingdom
char *TextResReports::str_nat_kingdom() { return get_format_str(39, "NKIN"); }
...
// text id 41
// [NSTA]Status
char *TextResReports::str_nat_status() { return get_format_str(41, "NSTA"); }
...
char *TextResReports::str_disconnect() { return get_format_str(51, "DISC"); }
...
// text id 54
// [YFOO]Your Food
char *TextResReports::str_your_food() { return get_format_str(54, "YFOO"); }

// text id 55
// [YCAS]Your Treasure
char *TextResReports::str_your_treasure() { return get_format_str(55, "YCAS"); }
...
// text id 73
// [TOWN]Town
char *TextResReports::str_town() { return get_format_str(73, "TOWN"); }

// text id 74
// [CITZ]Citizens
char *TextResReports::str_citizens() { return get_format_str(74, "CITZ"); }

// text id 75
// [PEAS]Peasants
char *TextResReports::str_peasants() { return get_format_str(75, "PEAS"); }

// text id 76
// [NATL]Nationality
char *TextResReports::str_nationality() { return get_format_str(76, "NATL"); }

// text id 77
// [STRU]Structure
char *TextResReports::str_structure() { return get_format_str(77, "STRU"); }

// text id 78
// [UNCO]Unit Cost
char *TextResReports::str_unit_cost() { return get_format_str(78, "UNCO"); }
...
// text id 81
// [YINC]Yearly Income
char *TextResReports::str_yearly_income() { return get_format_str(81, "YINC"); }

// text id 82
// [TTWN]Total %1p{Town|Towns}: %1d
char *TextResReports::str_total_towns(int townNum) {
  return process(get_format_str(82, "TTWN"), townNum);
}

// text id 83
// [TCTZ]Total %1p{Citizen|Citizens}: %1d
char *TextResReports::str_total_citizens(int num) {
  return process(get_format_str(83, "TCTZ"), num);
}

// text id 84
// [TPEA]Total %1p{Peasant|Peasants}: %1d
char *TextResReports::str_total_peasant(int num) {
  return process(get_format_str(84, "TPEA"), num);
}

// text id 85
// [TOUN]Total Other Units: %1d
char *TextResReports::str_total_other_units(int num) {
  return process(get_format_str(85, "TOUN"), num);
}

// text id 86
// [TPOP]Total Population: %1d
char *TextResReports::str_total_population(int population) {
  return process(get_format_str(86, "TPOP"), population);
}

// text id 87
// [TOTL]Total
char *TextResReports::str_total() { return get_format_str(87, "TOTL"); }

// text id 88
// [INCI]Income Item
char *TextResReports::str_income_item() { return get_format_str(88, "INCI"); }

// text id 89
// [EXPI]Expense Item
char *TextResReports::str_expense_item() { return get_format_str(89, "EXPI"); }
...
char *TextResReports::str_income_desc(int incomeType, int isMonster) {
  ...
  if (incomeType == INCOME_SELL_GOODS) { // check only the first
...
char *TextResReports::str_total_caravan(int count) {
  return process(get_format_str(144, "TCAR"), count);
}
...
// text id 147
// [STAT]Status
char *TextResReports::str_mil_status() { return get_format_str(147, "STAT"); }
...
// text id 160
// [TECH]Technology
char *TextResReports::str_technology() { return get_format_str(160, "TECH"); }
...
char *TextResReports::str_tech_acq_scroll(int num) {
  return process(get_format_str(164, "ACQS"), num);
}
...
// text id 167
// [SPNM]Spy Name
char *TextResReports::str_spy_name() { return get_format_str(167, "SPNM"); }

// text id 168
// [SPCL]Cloak
char *TextResReports::str_spy_cloak() { return get_format_str(168, "SPCL"); }

// text id 169
// [SPLO]Location
char *TextResReports::str_spy_location() { return get_format_str(169, "SPLO"); }

// text id 170
// [SPSK]Skill
char *TextResReports::str_skill() { return get_format_str(170, "SPSK"); }

// text id 171
// [SPAC]Action
char *TextResReports::str_spy_action() { return get_format_str(171, "SPAC"); }

// text id 172
// [TSPY]Total %1p{Spy|Spies}: %1d
char *TextResReports::str_total_spy(int num) {
  return process(get_format_str(172, "TSPY"), num);
}
...
// text id 179
// [OVRA]Overall
char *TextResReports::str_overall() { return get_format_str(179, "OVRA"); }
...
char *TextResReports::str_goal_and() { return get_format_str(191, "GAND"); }

// text id 192
// [G_OR]GOAL: Achieve One of the Following
char *TextResReports::str_goal_or() { return get_format_str(192, "G_OR"); }

// text id 193
// [GOAL]GOAL:
char *TextResReports::str_goal_() { return get_format_str(193, "GOAL"); }
...
// text id 198
// [LOSE]LOSE:
char *TextResReports::str_lose_() { return get_format_str(198, "LOSE"); }
...
// text id 201
// [CYPA]The game started on %1s and you have been playing for %2d
// %2p{year|years}.
char *TextResReports::str_campaign_year_passed(char *startDateStr,
                                               int yearPassed) {
  return process(get_format_str(201, "CYPA"), startDateStr, yearPassed);
}
