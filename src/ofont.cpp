...
void Font::put_paragraph(int x1, int y1, int x2, int y2, const char *textPtr, int lineSpace, int startLine,
                         char dispFlag)
{
    ...
    while (1)
    {
        ...
        if (newWord)
        {
            ...
            if (*textPtr == '\0' || *textPtr == TEXT_END_CHAR) // all paragraph has been printed, 26 =
...
void Font::center_put_paragraph(int x1, int y1, int x2, int y2, const char *desStr, int lineSpace, char clearBack,
                                int cap)
{
...
//
void Font::count_line(int x1, int y1, int x2, int y2, const char *textPtr, int lineSpace, int &dispLines,
                      int &totalLines)
{
    dispLines = 0;
    totalLines = 0;
...
//
void Font::field(int xDes, int y1, const char *desStr, int xValue, int value, int format, int xEnd, int refreshFlag,
                 const char *helpCode)
{
    int x2;
...
// [char*] helpCode  = help code
//
void Font::field(int xDes, int y1, const char *desStr, int xValue, double value, int format, int xEnd, int refreshFlag,
                 const char *helpCode)
{
    int x2;
...
// [char*] helpCode  = help code
//
void Font::field(int xDes, int y1, const char *desStr, int xValue, const char *value, int xEnd, int refreshFlag,
                 const char *helpCode)
{
    int x2;
...
void Font::put_to_buffer(char *dest, int destPitch, int x1, int y1, const char *text)
{
    ...
    while (*text != '\0' && x1 < x2)
    {
        ...
        int charWidth = textChar == ' ' ? space_width : (font_info_array + textChar - first_char)->width;
