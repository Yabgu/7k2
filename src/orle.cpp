...
//
long Rle::compress(unsigned char *inPtr, long inByteLen, unsigned char *outPtr,
...
// expand from memory
//
long Rle::expand(unsigned char *inPtr, unsigned char *outPtr,
                 unsigned char rleKey) {
  register unsigned char *p = inPtr;
...
//
long Rle::compress(unsigned char *inPtr, long inByteLen, File *outFile,
                   unsigned char rleKey) {
...
void test_rle() {
  ...
  unsigned char testStr[] = {
      0x00, 0x01, 0x02, 0x02, 0x03, 0x03, 0x03, 0x03, 0x03, 0xff, 0x00, 0xff,
