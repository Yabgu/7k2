...
void TextResGameMenu::init() { TextResource::init(DIR_RES "T_GMENU.RES"); }
...
// text id 2
// [VERD]Demo Version
char *TextResGameMenu::str_demo_version() { return get_format_str(2, "VERD"); }

// text id 3
// [VERB]This is a Beta version. Unauthorized distribution of this Beta is
// strictly prohibited.
char *TextResGameMenu::str_beta_version() { return get_format_str(3, "VERB"); }

// text id 4
// [SPLR]Single Player
char *TextResGameMenu::str_single_player() { return get_format_str(4, "SPLR"); }

// text id 5
// [MPLR]Multi Player
char *TextResGameMenu::str_multi_player() { return get_format_str(5, "MPLR"); }
...
// text id 7
// [HOFM]Hall of Fame
char *TextResGameMenu::str_hall_of_fame() { return get_format_str(7, "HOFM"); }

// text id 8
// [CRED]Credits
char *TextResGameMenu::str_credits() { return get_format_str(8, "CRED"); }
...
// text id 10
// [WEBS]Web Site
char *TextResGameMenu::str_web_site() { return get_format_str(10, "WEBS"); }

// text id 11
// [QUIT]Quit
char *TextResGameMenu::str_quit() { return get_format_str(11, "QUIT"); }

// text id 12
// [TRAN]Training
char *TextResGameMenu::str_training() { return get_format_str(12, "TRAN"); }

// text id 13
// [NEWC]New Campaign
char *TextResGameMenu::str_new_campaign() { return get_format_str(13, "NEWC"); }
...
// text id 15
// [LO_G]Load Game
char *TextResGameMenu::str_load_game() { return get_format_str(15, "LO_G"); }
...
// text id 17
// [CANC]Cancel
char *TextResGameMenu::str_cancel() { return get_format_str(17, "CANC"); }

// text id 18
// [NEWG]New Game
char *TextResGameMenu::str_new_game() { return get_format_str(18, "NEWG"); }

// text id 19
// [NEWP]New Player
char *TextResGameMenu::str_new_profile() { return get_format_str(19, "NEWP"); }
...
char *TextResGameMenu::str_profile_s1() { return get_format_str(22, "PRF1"); }

// text id 23
// [PRF2]If your name is not here, click on "New Player" below
char *TextResGameMenu::str_profile_s2() { return get_format_str(23, "PRF2"); }

// text id 24
// [PRFN]Please enter your name
char *TextResGameMenu::str_profile_new() { return get_format_str(24, "PRFN"); }

// text id 25
// [PRFD]Are you Certain that you wish to delete this person from the list?
char *TextResGameMenu::str_profile_del() { return get_format_str(25, "PRFD"); }
...
// text id 33
// [STRT]Start
char *TextResGameMenu::str_start() { return get_format_str(33, "STRT"); }

// text id 34
// [NATH]Nationality
char *TextResGameMenu::str_nationality() { return get_format_str(34, "NAHS"); }

// text id 35
// [NATF]Fryhtan Species
char *TextResGameMenu::str_species() { return get_format_str(35, "NAFS"); }

// text id 36
// [COLR]Color
char *TextResGameMenu::str_color() { return get_format_str(36, "COLR"); }
...
// text id 38
// [HAH_]Human
char *TextResGameMenu::str_human() { return get_format_str(38, "NAH_"); }

// text id 39
// [HAF_]Fryhtan
char *TextResGameMenu::str_fryhtan() { return get_format_str(39, "NAF_"); }
...
// text id 43
// [TER_]Terrain Set
char *TextResGameMenu::str_terrain_set() { return get_format_str(43, "TER_"); }
...
// text id 46
// [BLD_]Building Size
char *TextResGameMenu::str_building_set() { return get_format_str(46, "BLD_"); }
...
// text id 49
// [KDOF]Kingdom of
char *TextResGameMenu::str_kingdom_of() { return get_format_str(49, "KDOF"); }

// text id 50
// [KGOF]King of
char *TextResGameMenu::str_king_name() { return get_format_str(50, "KGOF"); }

// text id 51
// [EXPL]World Map
char *TextResGameMenu::str_world_map() { return get_format_str(51, "EXPL"); }
...
// text id 54
// [FOGW]Fog of War
char *TextResGameMenu::str_fog_of_war() { return get_format_str(54, "FOGW"); }
...
char *TextResGameMenu::str_ai_treasure() { return get_format_str(56, "ATRE"); }
...
char *TextResGameMenu::str_raw_nearby() { return get_format_str(87, "RAWN"); }
...
char *TextResGameMenu::str_mp_latency() { return get_format_str(105, "MPNL"); }

// text id 106
// [CONT]Continue
char *TextResGameMenu::str_continue() { return get_format_str(106, "CONT"); }

// text id 107
// [CREA]Create
char *TextResGameMenu::str_create() { return get_format_str(107, "CREA"); }

// text id 108
// [JOIN]Join
char *TextResGameMenu::str_join() { return get_format_str(108, "JOIN"); }

// text id 109
// [RDY_]Ready
char *TextResGameMenu::str_ready() { return get_format_str(109, "RDY_"); }

// text id 110
// [WASV]It is not recommended to use this save game file name, do you wish to
// continue?
...
// text id 116
// [MPOK]Ok
char *TextResGameMenu::str_mp_host_ok() { return get_format_str(116, "MPOK"); }
...
// text id 128
// [CD4P]There are not enough Seven Kingdoms II CDROMs to start the game. Each
// CDROM supports four players.
char *TextResGameMenu::str_mp_cd_count() { return get_format_str(128, "CD4P"); }

// text id 129
// [MPLP]This multiplayer saved game needs %2d human players while now there
// %1p{is|are} only %1d human %1p{player|players}. The game cannot start. text
// id 130 [MPGP]This multiplayer saved game can only support %2d human
// %2p{player|players} while now there are %1d human players. The game cannot
// start.
...
// text id 146
// [BONU]Bonus
char *TextResGameMenu::str_bonus() { return get_format_str(146, "BONU"); }
...
// text id 148
// [SV_G]Save Game
char *TextResGameMenu::str_save_game() { return get_format_str(148, "SV_G"); }
...
// text id 150
// [SAVE]Save
char *TextResGameMenu::str_save() { return get_format_str(150, "SAVE"); }

// text id 151
// [SAVN]Save New
char *TextResGameMenu::str_save_new() { return get_format_str(151, "SAVN"); }

// text id 152
// [LOAD]Load
char *TextResGameMenu::str_load() { return get_format_str(152, "LOAD"); }

// text id 153
// [DELS]Delete
char *TextResGameMenu::str_delete_save() { return get_format_str(153, "DELS"); }
...
// text id 158
// [GDAT]Game Date:
char *TextResGameMenu::str_game_date() { return get_format_str(158, "GDAT"); }

// text id 159
// [FDAT]File Date:
char *TextResGameMenu::str_file_date() { return get_format_str(159, "FDAT"); }

// text id 160
// [FNAM]File Name:
char *TextResGameMenu::str_file_name() { return get_format_str(160, "FNAM"); }
...
// text id 185
// [1LES]You are about to start a Training Game. It will help you to get up to
// speed with the game quickly.
...
// text id 187
// [OPTN]Options
char *TextResGameMenu::str_option() { return get_format_str(187, "OPTN"); }

// text id 188
// [RSTT]Restart Game
char *TextResGameMenu::str_restart() { return get_format_str(188, "RSTT"); }
...
char *TextResGameMenu::str_quit_main() { return get_format_str(193, "QTMM"); }

// text id 194
// [QWIN]Quit to Windows
char *TextResGameMenu::str_quit_game() { return get_format_str(194, "QWIN"); }
...
char *TextResGameMenu::str_ask_restart() { return get_format_str(196, "ASRS"); }
...
char *TextResGameMenu::str_se_vol() { return get_format_str(202, "SEVO"); }

// text id 203
// [MUSI]Music
char *TextResGameMenu::str_music() { return get_format_str(203, "MUSI"); }

// text id 204
// [HELP]Help
char *TextResGameMenu::str_help() { return get_format_str(204, "HELP"); }
...
// text id 206
// [GSPD]Game Speed
char *TextResGameMenu::str_game_speed() { return get_format_str(206, "GSPD"); }
...
char *TextResGameMenu::str_report_bg() { return get_format_str(208, "REPB"); }
...
char *TextResGameMenu::str_inside_info() { return get_format_str(211, "IINF"); }
...
// text id 231
// [RETU]Return
char *TextResGameMenu::str_return() { return get_format_str(231, "RETU"); }
...
char *TextResGameMenu::str_capture_screen(char *fileName) {
  return process(get_format_str(240, "CAPF"), fileName);
}
...
char *TextResGameMenu::str_cheat_tech() { return get_format_str(242, "CHTG"); }
...
char *TextResGameMenu::str_mp_wait_player(char *nationStr, char *colorCodeStr) {
  return process(get_format_str(258, "WAIT"), nationStr, colorCodeStr);
}
...
// text id 270
// [TIPN]Next Tip
char *TextResGameMenu::str_tips_next() { return get_format_str(270, "TIPN"); }

// text id 271
// [TIPP]Previous Tip
char *TextResGameMenu::str_tips_prev() { return get_format_str(271, "TIPP"); }

// text id 272
// [TIPD]Don't Show Tips
char *TextResGameMenu::str_tips_never() { return get_format_str(272, "TIPD"); }

// text id 273
// [TIPC]Close
char *TextResGameMenu::str_tips_close() { return get_format_str(273, "TIPC"); }

// text id 274
// [GOAW]You will be victorious when you have:
char *TextResGameMenu::str_goal() { return get_format_str(274, "GOAW"); }
...
const char *TextResGameMenu::str_mp_service_provider_name(int sp) {
  ...
  case 5:
    return "IMOnline"; // do not let Ubi to translate get_format_str( 281,
                       // "IMOS" );
  default:
    return "";
  };
...
char *TextResGameMenu::str_mp_gem_stones(int gemStones) {
  return process(get_format_str(296, "GEMS"), gemStones);
}
...
// text id 298
// [PRFL]Warning: This will delete all information in your multiplayer lobby
// account that is linked to this player profile.
...
char *TextResGameMenu::str_mp_ranking(char *nationName, char colorScheme,
                                      int ps, int ms, int es, int rs, int fbs,
                                      int ts) {
  char colorBoxStr[2] = " ";
  colorBoxStr[0] = FIRST_NATION_COLOR_CODE_IN_TEXT + colorScheme;

  return process(get_format_str(299, "#rL0"), nationName, colorBoxStr, ps, ms,
                 es, rs, fbs, ts);
}
...
char *TextResGameMenu::str_mp_gem_stones_inst(int gain) {
  return process(get_format_str(320, "GEMI"), gain);
}
