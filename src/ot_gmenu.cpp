...
char *TextResGameMenu::str_mp_ranking(char *nationName, char colorScheme, int ps, int ms, int es, int rs, int fbs,
                                      int ts)
{
    char colorBoxStr[2] = " ";
    colorBoxStr[0] = FIRST_NATION_COLOR_CODE_IN_TEXT + colorScheme;

    return process(get_format_str(299, "#rL0"), nationName, colorBoxStr, ps, ms, es, rs, fbs, ts);
}
