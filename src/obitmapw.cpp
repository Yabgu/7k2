...
short BitmapW::get_pitch() { return width_field; }
// ------ end of function BitmapW::get_pitch ------//

// ------ begin of function BitmapW::get_true_pitch ------//

short BitmapW::get_true_pitch() { return width_field * sizeof(short); }
// ------ end of function BitmapW::get_pitch ------//
...
long BitmapW::size() {
  return sizeof(width_field) + sizeof(height_field) +
         width_field * height_field * sizeof(short);
}
