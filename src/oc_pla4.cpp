...
{
    plot_nation_recno1 =
        nation_array.new_nation(NATION_MONSTER, NATION_AI, -MONSTER_MINOTAUROS, nation_array.random_unused_color());
    ...
    for (int i = 1; i <= site_array.size(); ++i)
    {
        ...
        {
            int firmRecno = firm_array.generate_firm(sitePtr->map_x_loc, sitePtr->map_y_loc, plot_nation_recno1,
