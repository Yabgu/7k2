...
int News::is_major()
{
    if (id == NEWS_TOWN_REBEL)
    {
        ...
        return nation_array.player_recno && nation_recno1 == nation_array.player_recno;
    }
    else
    {
...
void News::town_rebel()
{
    ...
    /*
            ...
            if( short_para2 > 1 )
                    ...
                    str += " is rebelling.";
    */
    str = text_news.process(text_news.get_format_str(11, "TRBL"), town_res.get_name(short_para1), short_para2,
                            nation_name1());
}
...
void News::migrate()
{
    ...
    /*
            ...
            if( nation_array.player_recno && nation_recno1 ==
       nation_array.player_recno )		// from player nation to another
       nation
            {
                    ...
                    if( nation_recno2 )		// only if it is not an
       independent town
                    {
                            str += " in ";
                            str += nation_name2();
    ...
    */
    ...
    if (nation_array.player_recno && nation_recno1 == nation_array.player_recno)
    {
        ...
        str =
            text_news.process(text_news.get_format_str(12, "MIGE"), town_res.get_name(short_para1), (char *)toTownName,
    ...
    else
    {
        ...
        str = text_news.process(text_news.get_format_str(13, "MIGI"), (char *)fromTownName,
                                town_res.get_name(short_para2), race_res[short_para3]->name, short_para4,
...
void News::new_nation()
{
    ...
    str = text_news.process(text_news.get_format_str(14, "NEWK"), king_name1(1));
}
...
void News::nation_destroyed()
{
    ...
    str = text_news.process(text_news.get_format_str(15, "DE_K"), nation_name1());
}
...
void News::nation_surrender()
{
    ...
    //	if( nation_array.player_recno && nation_recno2 ==
    ...
    if (nation_array.player_recno && nation_recno2 == nation_array.player_recno)
        str = text_news.process(text_news.get_format_str(16, "SURY"), nation_name1());
    else
        str = text_news.process(text_news.get_format_str(17, "SURO"), nation_name1(), nation_name2());
}
...
void News::king_die()
{
    ...
    if (nation_array.player_recno && nation_recno1 == nation_array.player_recno)
    {
        ...
        str = text_news.process(text_news.get_format_str(18, "YDIE"), text_unit.str_title(nation_race_id1, RANK_KING),
                                king_name1());
    }
    else
    {
        ...
        str = text_news.process(text_news.get_format_str(19, "KDIE"), text_unit.str_title(nation_race_id1, RANK_KING),
                                king_name1(), nation_name1());
    }
}
...
void News::new_king()
{
    ...
    if (nation_array.player_recno && nation_recno1 == nation_array.player_recno)
    {
        ...
        str = text_news.process(text_news.get_format_str(20, "YKNG"), get_unit_name(short_para1, short_para2),
                                text_unit.str_title(short_para1, RANK_KING));
    }
    else
    {
        //		if( short_para1 >= 0 )
        ...
        //"; 		str += nation_name1(); 		str += ".";

        str = text_news.process(text_news.get_format_str(21, "KKNG"), get_unit_name(short_para1, short_para2),
                                text_unit.str_title(short_para1, RANK_KING), nation_name1());
    }
}
...
void News::firm_destroyed()
{
    ...
    /*
            ...
            if( short_para2 > 0 )			// it is possible that there is
       no town in the map
            {
                    str += " near ";
                    str += town_res.get_name(short_para2);
    ...
    */
    ...
    if (short_para2 > 0) // it is possible that there is no town in the map
        firmPhrase =
            text_news.str_firm_near_town(firm_res.get_build(short_para1)->name, town_res.get_name(short_para2));
    else
    ...
    {
    case DESTROYER_NATION:
        str = text_news.process(text_news.get_format_str(22, "FDEN"), (char *)firmPhrase, nation_name2());
        break;
    case DESTROYER_REBEL:
        str = text_news.process(text_news.get_format_str(23, "FDER"), (char *)firmPhrase);
        break;
    case DESTROYER_MONSTER:
        str = text_news.process(text_news.get_format_str(24, "FDEF"), (char *)firmPhrase);
        break;
    case DESTROYER_UNKNOWN:
    default:
        str = text_news.process(text_news.get_format_str(25, "FDE?"), (char *)firmPhrase);
        break;
    }
}
...
void News::firm_attacked()
{
    ...
    */
    ...
    {
    case DESTROYER_NATION:
        str = text_news.process(text_news.get_format_str(26, "FATN"), (char *)firmPhrase, nation_name2());
        break;
    case DESTROYER_REBEL:
        str = text_news.process(text_news.get_format_str(27, "FATR"), (char *)firmPhrase);
        break;
    case DESTROYER_MONSTER:
        str = text_news.process(text_news.get_format_str(28, "FATF"), (char *)firmPhrase);
        break;
    case DESTROYER_UNKNOWN:
    default:
        str = text_news.process(text_news.get_format_str(29, "FAT?"), (char *)firmPhrase);
        break;
    }
}
...
void News::firm_captured()
{
    ...
    */
    ...
    if (!short_para3) // short_para3 = capture by spy
        str = text_news.process(text_news.get_format_str(30, "FCAN"), (char *)firmPhrase, nation_name2());
    else
        str = text_news.process(text_news.get_format_str(31, "FCAS"), (char *)firmPhrase, nation_name2());
}
...
void News::town_destroyed()
{
    ...
    */
    ...
    {
    case DESTROYER_NATION:
        str = text_news.process(text_news.get_format_str(32, "TDEN"), str_para1,
                                nation_name2()); // town_res.get_name(short_para1);
        break;
    case DESTROYER_REBEL:
...
void News::town_attacked()
{
    ...
    */
    ...
    {
    case DESTROYER_NATION:
        str = text_news.process(text_news.get_format_str(36, "TATN"), str_para1,
                                nation_name2()); // town_res.get_name(short_para1);
        break;
    case DESTROYER_REBEL:
...
void News::town_abandoned()
{
    ...
    str = text_news.process(text_news.get_format_str(40, "TABD"), town_res.get_name(short_para1));
}
...
void News::town_surrendered()
{
       ...
       nation_array.player_recno )
            {
                    ...
                    if( nation_recno1 )		// your town surrenders to
       another nation
                    {
                            str += " has surrendered to ";
                            str += nation_name1();
    ...
    */
    if (nation_array.player_recno && nation_recno2 == nation_array.player_recno)
    {
        ...
        {
            str =
                text_news.process(text_news.get_format_str(41, "YTSN"), town_res.get_name(short_para1), nation_name1());
        }
        else // your town declares independence
        {
            str = text_news.process(text_news.get_format_str(42, "YTSI"), town_res.get_name(short_para1));
        }
    }
    else
    {
        ...
        {
            str =
                text_news.process(text_news.get_format_str(43, "NTSY"), town_res.get_name(short_para1), nation_name2());
        }
        else // nation_recno2 == 0, it's an independent town
        {
            str = text_news.process(text_news.get_format_str(44, "ITSY"), town_res.get_name(short_para1));
        }
    }
}
...
void News::firm_idle()
{
    ...
    //	str  = "Your ";
    //	str += firm_res.get_build(short_para1)->name;
    //	if( short_para2 > 0 )			// it is possible that there is no
    // town
    // in the map
    //	{
    //		str += " near ";
    ...
    str = text_news.process(text_news.get_format_str(45, "IDLE"), (char *)firmPhrase);
}
...
void News::monster_king_killed()
{
    ...
    str = text_news.process(text_news.get_format_str(46, "FKDE"), monster_res[short_para1]->name);
}
...
void News::monster_firm_destroyed()
{
    ...
    str = text_news.process(text_news.get_format_str(47, "FLDE"), monster_res[short_para1]->name);
}
...
void News::scroll_acquired()
{
    ...
    if (nation_array.player_recno && nation_recno1 == nation_array.player_recno)
    {
        str = text_news.process(text_news.get_format_str(48, "YSOP"), race_res[short_para1]->adjective);
    }
    else
    {
        str = text_news.process(text_news.get_format_str(49, "NSOP"), race_res[short_para1]->adjective, nation_name1());
    }
}
...
void News::monster_gold_acquired()
{
    //---------------- Text Format -----------------//
    //
    // // Your have recovered <treasure amount> worth of treasure from the
    // Fryhtans. Your have recovered <treasure amount> worth of treasure.
    //
    //----------------------------------------------//
    ...
    str = text_news.process(text_news.get_format_str(50, "YTRE"), short_para1);
}
...
void News::your_spy_killed()
{
    ...
    /*
            ...
            {
                    str  = "Your spy has been exposed and executed on his mission
       to a "; str += firm_res.get_build(short_para1)->name;

                    if( short_para2 > 0 )			// it is possible that
       there is no town in the map
                    {
                            str += " near ";
                            str += town_res.get_name(short_para2);
                    }
            ...
            {
                    str  = "Your spy has been exposed and executed on his mission
       to "; str += town_res.get_name(short_para2);
    ...
    */
    ...
    if (short_para3 == SPY_FIRM)
    {
        ...
        {
            firmPhrase = text_news.str_firm_near_town_of_nation(firm_res.get_build(short_para1)->name,
                                                                town_res.get_name(short_para2), nation_name2());
        }
        ...
        {
            firmPhrase = text_news.str_firm_of_nation(firm_res.get_build(short_para1)->name, nation_name2());
        }
        else
        {
            firmPhrase = firm_res.get_build(short_para1)->name;
        ...
        str = text_news.process(text_news.get_format_str(51, "YSPF"), (char *)firmPhrase);
    }
    else if (short_para3 == SPY_TOWN)
    {
        String townPhrase;
        if (nation_recno2) // not for independent town.
            townPhrase = text_news.str_town_of_nation(town_res.get_name(short_para2), nation_name2());
        else
            townPhrase = town_res.get_name(short_para2);

        str = text_news.process(text_news.get_format_str(52, "YSPT"), (char *)townPhrase);
    }
    else
    {
        if (nation_recno2) // not for independent town.
        {
            str = text_news.process(text_news.get_format_str(53, "YSPN"), get_unit_name(short_para1, short_para2),
                                    nation_name2());
        }
        else
        {
            str = text_news.process(text_news.get_format_str(54, "YSPI"), get_unit_name(short_para1, short_para2));
        }
    }
}
...
void News::enemy_spy_killed()
{
    ...
    /*
            if( short_para3==SPY_FIRM || short_para3==SPY_TOWN )
            {
                    ...
                    if( short_para3==SPY_FIRM )
                    {
                            ...
                            if( short_para2 > 0 )			// it is
       possible that there is no town in the map
                            {
                                    str += " near ";
                                    str += town_res.get_name(short_para2);
                            }
    ...
    */
    ...
    if (short_para3 == SPY_FIRM)
    {
        ...
        str = text_news.process(text_news.get_format_str(55, "NSPF"), nation_name2(), (char *)firmPhrase);
    }
    else if (short_para3 == SPY_TOWN)
    {
        str = text_news.process(text_news.get_format_str(56, "NSPT"), nation_name2(), town_res.get_name(short_para2));
    }
    else
    {
        str = text_news.process(text_news.get_format_str(57, "NSP?"), get_unit_name(short_para1, short_para2),
                                nation_name2());
    }
}
...
void News::unit_betray()
{
    ...
    //----------------------------------------------//
    /*
            if( nation_recno1 == 0 )		// independent unit joining your
       force
            {
       ...
       nation_array.player_recno )
                    ...
                    else
                    {
                            ...
                            str += nation_name1();
                            // ####### begin Gilbert 21/1 #######//
                            if( short_para1 > 0 && (short_para4 == UNIT_WAGON
       // human, wagon or civilian
                                    || race_res[short_para1]->civilian_unit_id ==
       short_para4 ) ) str += " has defected to your Kingdom.";	// civilian else
                                    str += " has surrendered to your forces.";
       // soldier or other
                            // ####### end Gilbert 21/1 #######//
                    }
            }
    */
    if (nation_recno1 == 0) // independent unit joining your force
    {
        ...
        if (short_para4 == UNIT_WAGON) // race wagon
            str = text_news.process(text_news.get_format_str(137, "IWBY"), race_res[short_para1]->name,
                                    text_unit.str_nation(nation_race_id2));
        else if (short_para2 >= 0) // independent unit
                                   // ###### end Gilbert 30/6 #######//
            str = text_news.process(text_news.get_format_str(58, "IUBY"), get_unit_name(short_para1, short_para2));
        else // independent hero
            str = text_news.process(text_news.get_format_str(59, "IHBY"), get_unit_name(short_para1, short_para2));
    }
    else
    {
        String unitPhrase;
        ...
        {
            unitPhrase = text_unit.str_unit_titled(short_para1, get_unit_name(short_para1, short_para2), short_para3);
        }
        else
        {
        ...
        if (nation_recno2 == 0) // became an independent unit
        {
            ...
            str = text_news.process(text_news.get_format_str(60, "YUBI"), (char *)unitPhrase);
        }
                 ...
                 nation_array.player_recno == 0) // case right after defeated
        {
            ...
            str = text_news.process(text_news.get_format_str(61, "YUBN"), (char *)unitPhrase, nation_name2());
        }
        ...
        {
            str = text_news.process(text_news.get_format_str(62, "NCBY"), (char *)unitPhrase, nation_name1(),
                                    text_unit.str_nation(nation_race_id2));
        }
        else // military unit
        {
            str = text_news.process(text_news.get_format_str(63, "NSBY"), (char *)unitPhrase, nation_name1());
        }
    }
}
...
void News::general_die()
{
    ...
    str = text_news.process(text_news.get_format_str(64, "GDIE"), text_unit.str_title(short_para1, RANK_GENERAL),
...
void News::general_form_new_nation()
{
    ...
    */
    ...
    if (nation_array.player_recno && nation_recno1 == nation_array.player_recno)
    {
        str = text_news.process(text_news.get_format_str(65, "YGNK"), text_unit.str_title(short_para1, RANK_GENERAL),
                                get_unit_single_name(short_para1, short_para2), text_unit.str_nation(short_para1));
    }
    else
    {
        String unitPhrase;
        unitPhrase =
            text_unit.str_unit_titled(short_para1, get_unit_single_name(short_para1, short_para2), RANK_GENERAL);
        str = text_news.process(text_news.get_format_str(66, "NGNK"), (char *)unitPhrase, nation_name1(),
...
void News::unit_assassinated()
{
    ...
    */
    ...
    if (short_para1 == RANK_KING)
    {
        str = text_news.process(text_news.get_format_str(67, "ASSN"), text_unit.str_title(short_para2, short_para1),
                                king_name1());
    }
    else
    {
...
void News::assassinator_caught()
{
    ...
    //"; 	if( short_para1 == RANK_KING ) 		str += "King."; 	else
    // str += "General.";

    str = text_news.process(text_news.get_format_str(69, "NASF"), text_unit.str_title(short_para2, short_para1));
}
...
void News::raw_exhaust()
{
    ...
    str = text_news.process(text_news.get_format_str(70, "RWEX"), raw_res[short_para1]->name,
...
void News::tech_researched()
{
    ...
    /*
            ...
            if( tech_res[short_para1]->max_tech_level(0) > 1 )		// if
       the tech has more than one level
            {
                    if( tech_res[short_para1]->class_id == TECH_CLASS_WEAPON )
       // Weapon use "Mark", others use "Level" str += " Mark "; else str += "
       Level ";
    ...
    */
    ...
    if (tech_res[short_para1]->max_tech_level(0) > 1) // if the tech has more than one level
    {
        ...
        case TECH_CLASS_INCUBATION:
            str =
                text_news.process(text_news.get_format_str(71, "TECW"), tech_res[short_para1]->tech_des(), short_para2);
            break;
        default:
            str =
                text_news.process(text_news.get_format_str(72, "TECH"), tech_res[short_para1]->tech_des(), short_para2);
        }
    }
    else
    {
        str = text_news.process(text_news.get_format_str(73, "TEC1"), tech_res[short_para1]->tech_des());
    }
}
    ...
    */
    ...
    case NEWS_LOC_UNIT: {
        ...
        if (short_para4 == RANK_KING) // King/All High, no name
            ...
            unitPhrase = text_unit.str_unit_titled(short_para2, get_unit_name(short_para2, short_para3), short_para4);
        else
            unitPhrase = get_unit_name(short_para2, short_para3);

        if (!short_para5)
        { // injured
            str = text_news.process(text_news.get_format_str(74, "LIHU"), (char *)unitPhrase);
        }
        else
        { // killed
            str = text_news.process(text_news.get_format_str(75, "LIKU"), (char *)unitPhrase);
        }
    }
    break;
    ...
    case NEWS_LOC_FIRM: {
        ...
        if (short_para3)
            firmPhrase =
                text_news.str_firm_near_town(firm_res.get_build(short_para2)->name, town_res.get_name(short_para3));
        else
            firmPhrase = firm_res.get_build(short_para2)->name;

        if (!short_para5)
        { // injured
            str = text_news.process(text_news.get_format_str(76, "LIHF"), (char *)firmPhrase);
        }
        else
        { // killed
            str = text_news.process(text_news.get_format_str(77, "LIKF"), (char *)firmPhrase);
        }
    }
    break;
    ...
    case NEWS_LOC_TOWN:
        if (!short_para5)
        { // injured
            str = text_news.process(text_news.get_format_str(78, "LIHT"), town_res.get_name(short_para3));
        }
        else
        { // killed
            str = text_news.process(text_news.get_format_str(79, "LIKT"), town_res.get_name(short_para3));
        }
        break;
...
void News::earthquake_damage()
{
    ...
    */
    ...
    if (short_para1 == 1)
    {
        ...
        if (short_para3 == 0)
            str = text_news.process(text_news.get_format_str(80, "EQUI"), short_para2, playerNationTitle);
        else
            str = text_news.process(text_news.get_format_str(81, "EQUK"), short_para2, playerNationTitle, short_para3);
    }
    else if (short_para1 == 2)
    {
        str = text_news.process(text_news.get_format_str(82, "EQTK"), short_para2);
    }
    else if (short_para1 == 3)
    {
        if (short_para3 == 0)
            str = text_news.process(text_news.get_format_str(83, "EQFI"), short_para2);
        else
            str = text_news.process(text_news.get_format_str(84, "EQFK"), short_para2, short_para3);
    }
    else
    {
        err_here();
...
void News::goal_deadline()
{
    ...
    */
    ...
    str = text_news.process(text_news.get_format_str(85, "HAST"), (char *)timeLeftStr);
}
...
void News::weapon_ship_worn_out()
{
    ...
    //		str += misc.roman_number(short_para2);
    //	}
    //	str += " of yours has broken down due to the lack of maintenance
    // funds.";

    str = text_news.process(text_news.get_format_str(86, "WEPO"), unit_res[short_para1]->name, short_para2);
}
...
void News::firm_worn_out()
{
    ...
    //		str += town_res.get_name(short_para2);
    //	}
    //	str += " has fallen into disrepair due to the lack of maintenance
    // funds.";
    ...
    str = text_news.process(text_news.get_format_str(87, "FIMO"), (char *)firmPhrase);
}
...
void News::event_finish_tech()
{
    ...
    //	str = "A research breakthrough has been achieved and your current
...
void News::event_new_tech()
{
    ...
    str = text_news.process(text_news.get_format_str(89, "EVT2"), techInfo->tech_des(),
                            techInfo->max_tech_level(0) > 1 ? short_para2 : 0);
}
...
void News::event_food_destroyed()
{
    ...
    str = text_news.process(text_news.get_format_str(90, "EVFO"), short_para1);
}
...
void News::event_unit_die()
{
    ...
    */
    ...
    {
    case RANK_KING:
        str = text_news.process(text_news.get_format_str(91, "EVKD"), text_unit.str_title(short_para1, short_para3));
        break;
    case RANK_GENERAL:
        str = text_news.process(text_news.get_format_str(92, "EVGD"), text_unit.str_title(short_para1, short_para3),
                                get_unit_single_name(short_para1, short_para2));
        break;
    case RANK_SOLDIER:
        str = text_news.process(text_news.get_format_str(93, "EVUD"), get_unit_single_name(short_para1, short_para2));
        break;
    default:
        err_here();
        break;
...
void News::event_soldier_die()
{
    ...
    */
    ...
    {
        str =
            text_news.process(text_news.get_format_str(94, "EVHP"), short_para3, firm_res.get_build(short_para1)->name);
    }
    else
    {
        str =
            text_news.process(text_news.get_format_str(95, "EVFP"), short_para3, firm_res.get_build(short_para1)->name);
    }
}
...
void News::event_item_found()
{
    ...
    str = text_news.process(text_news.get_format_str(96, "EVIF"), town_res.get_name(short_para1));
}
...
void News::event_town_people_killed()
{
    ...
    */
    ...
    str = text_news.process(text_news.get_format_str(97, "EVTP"), short_para2, town_res.get_name(short_para1));
}
...
void News::event_factory_destroyed()
{
    ...
    */
    ...
    str = text_news.process(text_news.get_format_str(98, "EVFD"), firm_res.get_build(short_para1)->name, short_para3);
}
...
void News::event_mine_destroyed()
{
    ...
    */
    str = text_news.process(text_news.get_format_str(99, "EVMD"), short_para3);
}
...
void News::event_inn_destroyed()
{
    ...
    */
    ...
    str = text_news.process(text_news.get_format_str(100, "EVID"), (char *)firmPhrase);
}
...
void News::blueprint_acquired()
{
    ...
    */
    ...
    if (nation_array.player_recno && nation_recno1 == nation_array.player_recno)
    {
        str = text_news.process(text_news.get_format_str(110, "YGWS"), tech_res[short_para1]->tech_des());
    }
    else
    {
        str =
            text_news.process(text_news.get_format_str(111, "NGWS"), tech_res[short_para1]->tech_des(), nation_name1());
    }
}
...
void News::magic_tower_attack()
{
    ...
    */
    ...
    if (nation_array.player_recno && nation_recno1 == nation_array.player_recno)
    {
        ...
        {
        case OBJ_UNIT:
            str = text_news.process(text_news.get_format_str(112, "MGYU"), magicTowerName);
            break;
        case OBJ_FIRM: {
            String firmPhrase;
            if (short_para2 > 0)
            ...
            str = text_news.process(text_news.get_format_str(113, "MGYF"), magicTowerName, (char *)firmPhrase);
        }
        break;
        case OBJ_TOWN:
            str = text_news.process(text_news.get_format_str(114, "MGYT"), magicTowerName,
                                    town_res.get_name(short_para2));
            break;
        default:
            str = text_news.process(text_news.get_format_str(115, "MGY?"), magicTowerName,
                                    text_unit.str_nation(nation_race_id1));
        }
    }
    else
    {
        if (nation_recno1)
        {
            str = text_news.process(text_news.get_format_str(116, "MGYN"), magicTowerName, nation_name1());
        }
        else
        {
            str = text_news.process(text_news.get_format_str(117, "MGYI"), magicTowerName);
        }
    }
}
...
void News::multi_retire()
{
    ...
    str = text_news.process(text_news.get_format_str(133, "MP_R"), nation_name1());
}
...
void News::multi_quit_game()
{
    ...
    str = text_news.process(text_news.get_format_str(134, "MP_Q"), nation_name1());
}
...
void News::multi_save_game()
{
    ...
    str = text_news.process(text_news.get_format_str(135, "MP_S"), remote.save_file_name);
}
...
void News::multi_connection_lost()
{
    ...
    str = text_news.process(text_news.get_format_str(136, "MP_L"), nation_name1());
}
