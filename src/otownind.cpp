...
int Town::think_independent_form_new_nation()
{
    ...
    if (!nation_array.can_form_new_ai_nation()) // this function looks at config
...
int Town::think_independent_unit_join_nation()
{
    ...
    independent_unit_join_nation_min_rating -= 2; // make it easier to join nation everytime it's called
                                                  ...
                                                  // calling it once every 2 months make it a normal rate of joining
                                                  // once a year per town
    ...
    for (i = town_array.size(); i > 0; i--)
    {
        ...
        if (info.game_date <
            nationPtr->last_independent_unit_join_date + 90) // don't join too frequently, at most 3 months a unit
            continue;
...
int Town::independent_unit_join_nation(int toTownRecno)
{
    ...
    int unitRecno = mobilize_town_people(1,
