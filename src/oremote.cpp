...
void Remote::init(MultiPlayer *mp)
{
    ...
    // ###### patch begin Gilbert 22/1 #######//
    sync_test_level = (misc.is_file_exist("SYNC1.SYS") ? 1 : 0) | (misc.is_file_exist("SYNC2.SYS") ? 2 : 0);
...
DWORD
Remote::next_send_frame(int nationRecno, DWORD frameCount)
{
