...
//
void Item::next_day() { item_res.next_day(*this); }
//-------- end of function Item::next_day -------//

// ------- begin of function Item::item_name -----//
const char *Item::item_name() { return item_res.item_name(id, para); }
// ------- end of function Item::item_name -----//

// ------- begin of function Item::item_desc -----//
const char *Item::item_desc() { return item_res.item_desc(id, para); }
...
//
int Item::cost() { return item_res.item_cost(id, para); }
...
//
void Item::use_now() { item_res.use_now(*this); }
...
//
int Item::can_turn() { return item_res.can_turn(*this); }
...
// [int] unitId          unitId of the carrier, NULL if not carrier (default :
// 0) [Skill *]skillPtr     skill of the carrier, NULL if no carrier   (default
// : NULL)
//
void Item::init_random(int lowRare, int highRare, int unitId, Skill *skillPtr) {
  ...
  err_when(!unitId && skillPtr ||
           unitId && !skillPtr); // unitId and skillPtr must be both null
  // or both non-null
...
// randomize the para
//
void Item::random_para() { para = item_res.random_para(id, misc.rand()); }
