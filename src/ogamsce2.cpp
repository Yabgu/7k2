...
int Game::select_scenario(int scenCount, ScenInfo *scenInfoArray)
{
    ...
    // create one button for each path
    {
        ...
        for (i = 0; i < MAX_SCENARIO_PATH; ++i, (x1 += groupButtonWidth))
        {
            ...
            groupEnableButton[i].create_text(x1, SCROLL_SHEET_Y2 + 20, x1 + groupButtonWidth - 1,
    ...
    briefModeButton.create_text(SCROLL_SHEET_X2 - 140, SCROLL_SHEET_Y2 + 42, SCROLL_SHEET_X2 - 40, SCROLL_SHEET_Y2 + 62,
    ...
    int *scenIndex = (int *)blobScenIndex.p(); // gives the index in scenInfoArray, given 0 to
                                               // currentScenCount-1
    ...
    //"SV-DW-U", "SV-DW-D", 1, 0); 	startButton.create(menuX1+373,
    // menuY1+529, "START-U", "START-D",1, 0); cancelButton.create(menuX1+548,
    // menuY1+529, "CANCEL-U", "CANCEL-D", 1, 0);
    ...
    textScrollUp.create(TEXT_SCROLL_X1, TEXT_SCROLL_Y1 - 17, "SV-UP-U", "SV-UP-D", 1, 0);
    textScrollDown.create(TEXT_SCROLL_X1, TEXT_SCROLL_Y2 + 1, "SV-DW-U", "SV-DW-D", 1, 0);
    ...
    *(textBuffer.reserve(1)) = '\0';
    ...
    textScrollBar.init_scroll(TEXT_SCROLL_X1, TEXT_SCROLL_Y1, TEXT_SCROLL_X2, TEXT_SCROLL_Y2,
                              ESTIMATED_LINE_IN_TEXT_AREA, disp_scroll_bar_func);

    GetA playerNameField;
    playerNameField.init(364, 89, 632, config.player_name, config.PLAYER_NAME_LEN, &font_bold_black, 0, 1);
    ...
    while (1)
    {
        ...
        if (refreshFlag)
        {
            if (refreshFlag & TUOPTION_PAGE)
            {
                ...
                font_bld.center_put(TITLE_TEXT_X2 - 100, TITLE_TEXT_Y1 - 25, TITLE_TEXT_X2 - 50, TITLE_TEXT_Y2 - 8,
                                    text_game_menu.str_level_in_score());
                font_bld.center_put(TITLE_TEXT_X2 - 50, TITLE_TEXT_Y1 - 25, TITLE_TEXT_X2, TITLE_TEXT_Y2 - 8,
            ...
            if (refreshFlag & TUOPTION_TEXT_BUFFER)
            {
                ...
                if (browseRecno && misc.is_file_exist(str))
                {
                    ...
                    textFont.count_line(TEXT_AREA_X1, TEXT_AREA_Y1, TEXT_AREA_X2, TEXT_AREA_Y2, textBuffer.queue_buf,
            ...
            if (refreshFlag & TUOPTION_TEXT_AREA)
            {
                ...
                {
                    textFont.put_paragraph(TEXT_AREA_X1, TEXT_AREA_Y1, TEXT_AREA_X2, TEXT_AREA_Y2, textBuffer.queue_buf,
                                           TEXT_LINE_SPACE,
            ...
            if (refreshFlag & TUOPTION_TEXT_SCROLL)
            {
                ...
                if (textScrollBar.max_recno > ESTIMATED_LINE_IN_TEXT_AREA)
                    ...
                    vga_util.blt_buf(textScrollBar.scrn_x1, textScrollBar.scrn_y1, textScrollBar.scrn_x2,
                                     textScrollBar.scrn_y2, 0);
            }
        ...
        else if (textScrollBar.max_recno > ESTIMATED_LINE_IN_TEXT_AREA && textScrollBar.detect() == 1)
        {
