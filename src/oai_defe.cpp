...
int Nation::ai_defend(BaseObj *attackerObj)
{
    ...
    int enemyCombatLevel = mobile_defense_combat_level(attackerXLoc, attackerYLoc, attackerObj->nation_recno, 0,
                                                       hasWar); // 0-don't return immediately even if there is war
                                                                // around this town
