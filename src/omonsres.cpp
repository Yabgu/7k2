...
{
    err_if(monsterId < 1 || monsterId > monster_count) err_now("MonsterRes::operator[]");
...
void MonsterRes::second_init()
{
    ...
    enum
    {
        MONSTER_NAME_COUNT_FORMAT = 6
    };

    static const char *nameFormatArray[MONSTER_NAME_COUNT_FORMAT] = {"ABABC", "ABC", "ABCABC", "ABAB", "BCBC", "BCABC"};
