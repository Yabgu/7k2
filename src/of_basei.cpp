...
void FirmBase::disp_god_info(int dispY1, int refreshFlag)
{
    ...
    vga.active_buf->read_bitmapW(INFO_X1 + 80 - 13, INFO_Y1 + 49 + 48, INFO_X1 + 94 + size - 13, INFO_Y1 + 80 + 48,
                                 hitPointBitmap);
...
void FirmBase::detect_firm_info()
{
    ...
    // INFO_Y1+280+48, "GDINVOKE" ); 	help.set_help( INFO_X1+13+108,
    // INFO_Y1+261, INFO_X1+13+107+44, INFO_Y1+280+48, "BLESS" );
}
// -------- end of function FirmBase::disp_firm_info --------//
