...
enum
{
    STAGE_8_MONSTER_NATION_RECNO = 2
};
...
int CampaignEastWest::stage_8_create_game()
{
    ...
    create_troop(PLAYER_NATION_RECNO, 56 - campaign_difficulty * 6,
...
int CampaignEastWest::stage_8_create_lair()
{
    ...
    create_lair(cur_monster_nation_recno, STAGE_8_MONSTER_NATION_RECNO, lairAddCount, independentTownAddCount,
                specialFirmCount);
