...
int News::is_major()
{
    if (id == NEWS_TOWN_REBEL)
    {
        ...
        return nation_array.player_recno && nation_name_id1 == (~nation_array)->nation_name_id;
    }
    else
    {
...
void News::migrate()
{
    ...
    if (nation_array.player_recno &&
        nation_name_id1 == (~nation_array)->nation_name_id) // from player nation to another nation
    {
...
void News::town_abandoned()
{
    ...
    //----------------------------------------------//
    //
    // Tu aldea de <town name> ha sido abandonada por
    // su gente.
    //
    //----------------------------------------------//
...
void News::town_surrendered()
{
    ...
    //----------------------------------------------//
    //
    // La aldea de <town name> del <King's Kingdom> se
    // te ha rendido.
    //
    // La aldea independiente de <town name> se
    // te ha rendido.
    //
    // Tu aldea de <town name> se ha rendido
    // al <King's Kingdom>.
    //
    //----------------------------------------------//
...
void News::your_spy_killed()
{
    ...
    // <town name> [ del <nation name> ].  (no nation name for independent town.)
    //
    // Tu espía ha sido descubierto y ejecutado en
    // el/la <firm type name> cerca de <town name> del <nation name>.
    //
...
void News::lightning_damage()
{
    ...
    //
    // Un rayo ha alcanzado/destruido tu <firm name> cerca de <town name>.
    //
    // Un rayo ha alcanzado/destruido a tu aldea de <town name>.
    //
    //----------------------------------------------//
