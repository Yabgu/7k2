...
int CampaignEastWest::stage_22_create_game() {
  ...
  create_offensive_structure(STAGE_22_NEW_KINGDOM_NATION_RECNO,
                             campaign_difficulty);
...
int CampaignEastWest::stage_22_create_town() {
  ...
  return create_town(STAGE_22_NEW_KINGDOM_NATION_RECNO, townAddCount,
                     hasFortPercent);
}
...
int CampaignEastWest::stage_22_create_firm() {
  ...
  int townRecno2 = random_pick_town_with_camp(
      STAGE_22_NEW_KINGDOM_NATION_RECNO, 2); // only pick towns with <= 2 links
  ...
  townRecno2 = random_pick_town_with_camp(STAGE_22_NEW_KINGDOM_NATION_RECNO,
                                          2); // only pick towns with <= 2 links
