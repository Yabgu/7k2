...
short SlideBar::rect_left()
{
    ...
    if (is_empty())
        ...
        return bound(scrn_x1 + (view_recno - min_recno) * (scrn_x2 - scrn_x1 + 1 - scrn_bar_width) /
...
short SlideBar::rect_right()
{
    ...
    if (is_empty())
        ...
        return bound(scrn_x1 + scrn_bar_width - 1 +
                         (view_recno + view_size - min_recno) * (scrn_x2 - scrn_x1 + 1 - scrn_bar_width) /
                             (max_recno - min_recno + scroll_type),
                     scrn_x1, scrn_x2);
}
...
short SlideVBar::rect_top()
{
    ...
    if (is_empty())
        ...
        return bound(scrn_y1 + (view_recno - min_recno) * (scrn_y2 - scrn_y1 + 1 - scrn_bar_height) /
                                   (max_recno - min_recno + scroll_type),
                     scrn_y1, scrn_y2);
}
...
short SlideVBar::rect_bottom()
{
    ...
    if (is_empty())
        ...
        return bound(scrn_y1 + scrn_bar_height - 1 +
                         (view_recno + view_size - min_recno) * (scrn_y2 - scrn_y1 + 1 - scrn_bar_height) /
                             (max_recno - min_recno + scroll_type),
                     scrn_y1, scrn_y2);
}
