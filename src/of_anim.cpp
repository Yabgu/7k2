...
int FirmAnimal::can_hire(int recNo)
{
    ...
    return unit_res[animalUnit->unit_id]->get_nation_tech_level(nation_recno) > 0 &&
           nationPtr->cash >= animalUnit->hire_cost && nationPtr->live_points >= animalUnit->live_point_cost;
}
...
void FirmAnimal::update_add_hire_list()
{
    ...
    */
    ...
    short maxTechLevel = !nation_recno ? 2 : unit_res[addUnitId]->get_nation_tech_level(nation_recno);
