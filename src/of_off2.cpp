...
int FirmOffensive2::find_best_place_loc(short buildFirmId, short refXLoc, short refYLoc, short &resultXLoc,
...
int FirmOffensive2::create_firm_next_to_place(Place *placePtr, int firmId, int firmRaceId, int nationRecno,
                                              short distance)
{
