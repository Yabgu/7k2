...
int UnitInfo::nation_all_unit_count(int nationRecno)
{
    ...
    return nation_general_count_array[nationRecno - 1] + nation_unit_count_array[nationRecno - 1];
}
...
void UnitRes::load_class_info()
{
    ...
    for (int i = 0; i < unit_class_count; i++)
    {
        ...
        unitClassInfo->has_combat_level =
            unitClassRec->has_combat_level != ' ' && unitClassRec->has_combat_level != '0';
        ...
        unitClassInfo->has_weapon_version =
            unitClassRec->has_weapon_version != ' ' && unitClassRec->has_weapon_version != '0';
