...
static short edit_need_worker_x1, edit_need_worker_y1, edit_need_worker_x2, edit_need_worker_y2,
    edit_need_worker_enable;
...
static void disp_slide_bar(SlideBar *slideBar, int)
{
    ...
    vga.active_buf->put_bitmap_trans_remap_decompress(INFO_X1, INFO_Y1 + 213, nationPict,
...
void FirmWork::disp_edit_mode(int &refreshFlag, int &y, int dispBG)
{
    ...
    x = edit_need_worker_x2 =
        font_blue.put((edit_need_worker_x1 = x), (edit_need_worker_y1 = y), needed_worker_count, 0, x2);
...
int FirmWork::detect_edit_mode()
{
    ...
    {
        if (mouse.any_click(edit_need_worker_x1, edit_need_worker_y1, edit_need_worker_x2, edit_need_worker_y2,
                            LEFT_BUTTON))
        {
